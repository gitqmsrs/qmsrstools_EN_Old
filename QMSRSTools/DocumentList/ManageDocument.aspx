...
<script type="text/javascript" language="javascript">
    ...
    function loadGridView(data, empty)
    {
        ...
        $(xml).find("DocFile").each(function (index, value)
        {
            ...
            $("td", row).eq(8).html($(this).find("IssueDate").text() == '' ? '' : issuedate.format("dd/MM/yyyy"));
            ...
            $("td", row).eq(9).html($(this).find("LastReviewDate").text() == '' ? '' : lastreviewdate.format("dd/MM/yyyy"));
            ...
            $("td", row).eq(10).html($(this).find("NextReviewDate").text() == '' ? '' : nextreviewdate.format("dd/MM/yyyy"));
                ...
                if ($(this).attr('id').search('edit') != -1)
                {
                    $(this).bind('click', function ()
                    {
                        ...
                        else
                        {
                            ...
                            $("#<%=RMKTxt.ClientID%>").val($("#<%=RMKTxt.ClientID%>").html($(value).attr("Remarks")).text());
                        }

                        /*bind issue date*/
                        $("#<%=ISSUDTTxt.ClientID%>").val($(value).find("IssueDate").text() == '' ? '' : issuedate.format("dd/MM/yyyy"));

                        /*bind last review date*/
                        $("#<%=LREVDTTxt.ClientID%>").val($(value).find("LastReviewDate").text() == '' ? '' : lastreviewdate.format("dd/MM/yyyy"));

                        /*bind next review date*/
                        $("#<%=NXTREVDTTxt.ClientID%>").val($(value).find("NextReviewDate").text() == '' ? '' : nextreviewdate.format("dd/MM/yyyy"));
