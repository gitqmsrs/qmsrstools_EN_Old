...
<div id="wrapper" class="modulewrapper">
    ...
    <asp:Panel ID="panel1" runat="server" CssClass="modalPanel">
        ...
        <div style="float:left; width:100%; height:20px; margin-top:15px;">
           ...
           <%-- <asp:CompareValidator ID="ENDDTF2Val" runat="server" ControlToValidate="ENDDTTxt" ControlToCompare="STRTDTTxt"  ValidationGroup="Education"
             ErrorMessage="The end date of the education should be greater than its start date"
        ...
        <div id="divState" style="float:left; width:100%; height:20px; margin-top:15px; display:none;">
            ...
            <div style="float:left; width:100%; height:20px; margin-top:15px;">
                ...
                Display="None" ErrorMessage="Select the city of the education" Operator="NotEqual" Style="position: static"
                ValueToCompare="0" ValidationGroup="Education"></asp:CompareValidator>
            </div>
...
<script type="text/javascript" language="javascript">
            ...
            $("#<%=STRTDTTxt.ClientID%>").datepicker(
           {
            ...
            $("#new").bind('click', function () {
                if ($("#EmployeeJSON").val() != '')
                {
                    ...
                    //bindComboboxAjaxKeyValue('loadCountryList', '#<%=COUNTCBox.ClientID%>', countryID, "#CONTRY_LD");
        ...
        function loadEmployeeGridView(data, empty) {
            ...
            $(xml).find("Employee").each(function (index, employee) {
                ...
                $("td", row).eq(4).html(dateofbirth.format("dd/MM/yyyy"));
        ...
        function loadEducationGridView(data, empty) {
            ...
            $(xml).find("Education").each(function (index, education)
            {
                ...
                $("td", row).eq(6).html($(this).find("EndDate").text() == '' ? "From: " + startdate.format("dd/MM/yyyy") + " To: Present" : "From: " + startdate.format("dd/MM/yyyy") + " To: " + enddate.format("dd/MM/yyyy"));
                ...
                $(row).find('img').each(function () {
                    if ($(this).attr('id').search('delete') != -1) {
                        ...
                        $(this).bind('click', function ()
                        {
                            ...
                            /*bind end date field*/
                            $("#<%=ENDDTTxt.ClientID%>").val($(education).find("EndDate").text() == '' ? '' : enddate.format("dd/MM/yyyy"));
                           ...
                           <%-- /*bind country combobox*/
                            ...
                            /*bind country*/
                            var countryID = $(education).attr('CountryID');
                            //alert(countryID);
                            ...
                            if (countryID != null && countryID >= 0) {
                                ...
                                if (countryID == "1" || countryID == "2" || countryID == "95") {
                                    ...
                                    var stateID = $(education).attr('StateID');
                                    ...
                                    if (stateID != null && stateID > 0) {
                                        ...
                                        var cityID = $(education).attr('CityID');
