...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <img id="new" src="<%=GetSitePath() + "/Images/new_file.png" %>" class="imgButton" title="Add New Formula" alt=""/>    
...
<script type="text/javascript" language="javascript">
    $(function ()
    {
        ...
        $("#new").bind('click', function ()
        {
            ...
            $("#<%=RSKTYPCBox.ClientID%>").prop("disabled", false);
            $("#RiskTypeLabel").removeClass("labeldiv").addClass("requiredlabel");
            ...
            $(row).find('img').each(function ()
            {
                ...
                else if ($(this).attr('id').search('edit') != -1)
                {
                    $(this).bind('click', function ()
                    {
                        ...
                        $("#<%=RSKTYPCBox.ClientID%>").prop("disabled", true);

                        $("#RiskTypeLabel").removeClass("requiredlabel").addClass("labeldiv");
    ...
    function ActivateSave(isactive) {
        if (isactive == false) {
            ...
            $('#save.button').css({ opacity: 0.5 });
        }
        else {
            $(".modalPanel").css("cursor", "default");

            $('#save.button').attr("disabled", false);
            $('#save.button').css({ opacity: 100 });
        }
    }
</script>
</asp:Content>
