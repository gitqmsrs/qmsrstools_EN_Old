        ...
        function loadGridView(data, empty)
        {
            ...
            $(xmlRisk).find("Risk").each(function (i, risk)
            {
                ...
                $(xmlActions).find('MitigationAction').each(function (j, action)
                {
                    ...
                    $("td", row).eq(5).html($(this).find("ActualCloseDate").text() == '' ? '' : actualclosedate.format("dd/MM/yyyy"));
                    ...
                    $(row).find('img').each(function ()
                    {
                        if ($(this).attr('id').search('edit') != -1)
                        {
                            $(this).bind('click', function ()
                            {
                                ...
                                $("#<%=TRGTDTTxt.ClientID%>").val(targetclosedate.format("dd/MM/yyyy"));
                                ...
                                else
                                {
                                    ...
                                    $("#<%=PIMPTxt.ClientID%>").val($("#<%=PIMPTxt.ClientID%>").html($(action).attr("PotentialImpact")).text());
                                }
                                ...
                                else
                                {
                                    ...
                                    $("#<%=CMSURTxt.ClientID%>").val($("#<%=CMSURTxt.ClientID%>").html($(action).attr("Countermeasures")).text());
                                ...
                                else
                                {
                                    ...
                                    $("#<%=ACTTxt.ClientID%>").val($("#<%=ACTTxt.ClientID%>").html($(action).attr("Actions")).text());
