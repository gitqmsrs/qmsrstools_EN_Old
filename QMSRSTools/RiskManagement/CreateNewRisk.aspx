...
<div id="wrapper" class="modulewrapper">
    ...
    <div id="RiskGroupField" class="groupbox" style="height:520px;">
        ...
        <div id="ProbabilityTB" class="tabcontent" style="display:none; height:480px;">
            ...
            <div style="float:left; width:100%; height:20px; margin-top:10px;">
                ...
                <img id="PROBEdit" src="<%=GetSitePath() + "/Images/edit.png" %>" class="imgButton" alt="" title="Edit Probability Criteria"/>
            ...
            <div id="RiskGeneralEstimationGroup" class="groupbox" style="height:auto;">
                ...
                <div style="float:left; width:100%; height:20px; margin-top:15px;">
                    ...
                    <img id="TIMPEdit" src="<%=GetSitePath() + "/Images/edit.png" %>" class="imgButton" alt="" title="Edit Time Impact Criteria"/>
                    ...
                    <img id="TPROB_Help" src="<%=GetSitePath() + "/Images/help.png" %>" class="searchactive" style="margin-left:10px;" alt="" title="Maintain Probability Percentage Matrix"/>
                ...
                <div style="float:left; width:100%; height:20px; margin-top:15px;">
                    ...
                    <img id="CIMPEdit" src="<%=GetSitePath() + "/Images/edit.png" %>" class="imgButton" alt="" title="Edit Cost Impact Criteria"/>
                ...
                <div style="float:left; width:100%; height:20px; margin-top:15px;">
                    ...
                    <img id="QOSIMPEdit" src="<%=GetSitePath() + "/Images/edit.png" %>" class="imgButton" alt="" title="Edit Quality of Service Criteria"/>
                ...
                <div style="float:left; width:100%; height:20px; margin-top:15px;">
                    ...
                    <img id="STDIMPEdit" src="<%=GetSitePath() + "/Images/edit.png" %>" class="imgButton" alt="" title="Edit Standard Impact Cost Criteria"/>
            ...
            <div id="EMSGroup" class="groupbox" style="height:305px;">
               ...
               <div style="float:left; width:100%; height:20px; margin-top:15px;">
                    ...
                    <img id="SGNRAT_Help" src="<%=GetSitePath() + "/Images/help.png" %>" class="searchactive" style="margin-left:10px;" alt="" title="Maintain Significant Rating Criteria"/>   
    ...
    <asp:Panel ID="RateCriteriaPanel" runat="server" CssClass="modalPanel">
        ...
        <div class="toolbox">
            <img id="newrate" src="<%=GetSitePath() + "/Images/new_file.png" %>" class="imgButton" title="Create New Significant Rate Criteria" alt=""/> 
        </div>
...
<script type="text/javascript" language="javascript">
            ...
            if (isDetailsValid)
            {
                ...
                if (isRiskEstimationValue)
                {
                    ...
                    var risk =
                    {
                        ...
                        RegisterDate: moment(new Date(registeredDateParts[2], (registeredDateParts[1] - 1), registeredDateParts[0])),
    ...
    function removeElements() {
        $("#<%=PercentageProbabilityPanel.ClientID%> .row_img").remove();
    }
</script>
</asp:Content>
