...
<div id="wrapper" class="modulewrapper">
    ...
    <div id="ProblemGroupField" class="groupbox" style="height:500px;">
        ...
        <div id="CausesTB" class="tabcontent" style="display:none;height:400px;">
            ...
            <div id="treemenu" class="menucontainer" style="border: 1px solid #052556; overflow:auto;height:370px;">
                        ...
                        if (causes[0].name != 'new root cause') {
                            ...
                            if (result == true)
                            {
                                ...
                                if (node != null && node != false && node.Status != 3) {                            
                                    ...
                                    selectedCause = '[{"ParentID": "' + node.parent.CauseID + '", "Description":"' + node.Description + '","name":"' + node.name + '","Status":"' + node.Status + '", "is_open":true,"children":null,"isSelected":true}]';
                                }
