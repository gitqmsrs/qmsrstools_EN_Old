...
<div id="wrapper" class="modulewrapper"> 
     <div id="CCNApproval_Header" class="moduleheader">Problem Approval</div>
    ...
    <asp:Panel ID="panel1" runat="server" CssClass="modalPanel">
        ...
        <div id="SupplementaryTB" class="tabcontent" style="display:none; height:450px;">
            ...
            <div style="float:left; width:100%; height:20px; margin-top:15px;">
                <div id="Label" class="labeldiv">Assciated Risk List:</div>
...
<script type="text/javascript" language="javascript">
    $(function () {
        ...
        $("#<%=RTCUSCBox.ClientID%>").change(function ()
        {
            if ($(this).val() != 0)
            {
                ...
                loadProblemsByAPPMemberNDRoot(empty, employee, vals);
            }
        });
    ...
    function loadGridView(data, empty)
    {
        ...
        $(xml).find("Problem").each(function (index, value)
        {
            ...
            $("td", row).eq(6).html($(this).find("OriginationDate").text() == '' ? '' : originationdate.format("dd/MM/yyyy"));
            ...
            $("td", row).eq(7).html(targetclosedate.format("dd/MM/yyyy"));
