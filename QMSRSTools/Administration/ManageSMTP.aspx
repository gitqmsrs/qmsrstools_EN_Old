...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        <img id="newSMTP" src="/Images/new_file.png" class="imgButton" title="" alt=""/>   
    ...
    <asp:Panel ID="panel1" runat="server" style="display:none;">
        ...
        <div style="float:left; width:100%; height:20px; margin-top:10px;">
            ...
            <div id="UserNameField" class="fielddiv" style="width:250px">
                <asp:TextBox ID="txtUserName" runat="server" CssClass="textbox" Width="240px"></asp:TextBox>
            </div> 
            
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ValidationGroup="popup" ControlToValidate="txtUserName" CssClass="validator" ErrorMessage="Enter the username of the SMTP server"></asp:RequiredFieldValidator>            
            
        </div>
        <div style="float:left; width:100%; height:20px; margin-top:10px;">
            <div id="PasswordLabel" class="requiredlabel">Password</div>
            <div id="PasswordField" class="fielddiv" style="width:250px">
                <asp:TextBox ID="txtPassword" runat="server" CssClass="textbox" Width="240px" TextMode="Password"></asp:TextBox>
            </div> 
            
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="Dynamic" ValidationGroup="popup" ControlToValidate="txtPassword" CssClass="validator" ErrorMessage="Enter the password of the SMTP server"></asp:RequiredFieldValidator>
                    ...
                    $(row).find('img').each(function () {
                        if ($(this).attr('id').search('edit') != -1) {
                            $(this).bind('click', function () {
                                ...
                                $("#<%=txtUserName.ClientID%>").val($(value).attr("UserName"));
                                $("#<%=txtPassword.ClientID%>").val($(value).attr("Password"));
                                showSMTPDialog(empty);
                            });
                        }
