...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        <img id="new" src="<%=GetSitePath() + "/Images/new_file.png" %>" class="imgButton" title="Create new document file type" alt=""/>   
        <img id="refresh" src="<%=GetSitePath() + "/Images/refresh.png" %>" class="imgButton" title="Refersh Data" alt="" />
    </div>
