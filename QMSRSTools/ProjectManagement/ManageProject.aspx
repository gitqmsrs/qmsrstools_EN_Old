...
<script type="text/javascript" language="javascript">
    ...
    function loadGridView(data, empty) {
        ...
        $(xml).find("Project").each(function (index, value)
        {
            ...
            $("td", row).eq(4).html(startdate.format("dd/MM/yyyy"));
            ...
            $("td", row).eq(5).html(plannedclosedate.format("dd/MM/yyyy"));
            ...
            $("td", row).eq(6).html($(this).find("ActualCloseDate").text() == '' ? '' : actualclosedate.format("dd/MM/yyyy"));
                ...
                if ($(this).attr('id').search('edit') != -1)
                {
                    $(this).bind('click', function ()
                    {
                        ...
                        else
                        {
                            ...
                            $("#<%=PROJDESCTxt.ClientID%>").val($("#<%=PROJDESCTxt.ClientID%>").html($(value).attr("Description")).text());
                        }
                        ...
                        $("#<%=PLNNDCLSDTTxt.ClientID%>").val(plannedclosedate.format("dd/MM/yyyy"));
