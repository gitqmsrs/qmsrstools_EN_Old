    ...
    <div id="ProjectGroupField" class="groupbox" style="height:520px;">
        ...
        <div style="float:left; width:100%; height:20px; margin-top:15px;">
            ...
            <div id="StartDateField" class="fielddiv" style="width:150px">
                <asp:TextBox ID="STRTDTTxt" runat="server" CssClass="date" Width="140px" placeholder="dd/mm/yyyy" disabled="disabled"></asp:TextBox>
            </div>      
                    ...
                    if (result == true)
                    {
                        ...
                        $.ajax(
                        {
                            ...
                            success: function (data)
                            {
                                ...
                                $("#<%=STRTDTTxt.ClientID%>").datepicker('setDate', new Date());
