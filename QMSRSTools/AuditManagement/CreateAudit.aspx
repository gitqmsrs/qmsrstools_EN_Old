...
<div id="wrapper" class="modulewrapper">
    <div id="AUDT_Header" class="moduleheader">Create an Audit</div>
   
    <div class="toolbox">
        <img id="save" src="<%=ResolveUrl("~/Images/save.png") %>" class="imgButton" title="Save Changes" alt=""/> 
    </div>
    ...
    <div style="float:left; width:100%; height:20px; margin-top:5px;">
        ...
        <div id="DetailsTB" class="tabcontent" style="display:none; height:480px;">
            ...
            <div style="float:left; width:100%; height:20px; margin-top:15px;">
                ...
                <div id="ProcessDocumentField" class="fielddiv" style="width:250px">
                    <asp:TextBox ID="PROCDOCTxt" Width="240px" runat="server" CssClass="readonly" disabled="disabled">
                    </asp:TextBox>
                </div>
            ...
            <div id="project" class="selectionfield" style="float:left; width:100%; height:20px; margin-top:15px; display:none;">
                ...
                <div id="ProjectField" class="fielddiv" style="width:250px">
                    <asp:TextBox ID="PROJTxt" Width="240px" runat="server" CssClass="readonly" disabled="disabled">
                    </asp:TextBox>
                </div>
            ...
            <div id="supplier" class="selectionfield" style="float:left; width:100%; height:20px; margin-top:15px; display:none;">
                ...
                <div id="SupplierField" class="fielddiv" style="width:250px">
                    <asp:TextBox ID="SUPPTxt" Width="240px" runat="server" CssClass="readonly" disabled="disabled">
                    </asp:TextBox>
                </div>
        ...
        <div id="ORGUnitsTB" class="tabcontent" style="display:none;height:480px;">
            <span id="lblUnitMessage" class="validator" style="display:none;"></span>
            <div class="toolbox">
                <img id="refresh" src="<%=ResolveUrl("~/Images/refresh.png") %>" alt=""  class="selectBoxImg" title="Refresh Units"/>    
            </div>
        ...
        <div id="AuditorsTB" class="tabcontent" style="display:none;height:480px;">
            <span id="lblAuditorMessage" class="validator" style="display:none;"></span>
            <img id="newAuditor" src="<%=ResolveUrl("~/Images/new_file.png") %>" class="imgButton" title="Add new Auditor" alt=""/>
...
<script type="text/javascript" language="javascript">
    ...
    {
        $("td", row).eq(0).html("<img id='remove_" + length + "' src='<%=ResolveUrl("~/Images/deletenode.png") %>' class='imgButton'/>");
        //$("td", row).eq(1).html("<img id='edit_" + length + "' src='<%=ResolveUrl("~/Images/edit.png") %>' class='imgButton'/>");
    ...
    function addUnit(name)
    {
        ...
        $.ajax(
        {
            ...
            success: function (data)
            {
                ...
                //removed row's 'delete icon' since checkboxes toggle the addition/deletion of units
                $("#ORGUNTCHK").next("#datafield").children().find(".row_img").remove();
