...
<div id="wrapper" class="modulewrapper">
    ...
    <div id="CourseOption" class="optionbox" style="top:110px;">
        ...
        <div style="float:left; width:100%; height:20px; margin-top:5px;">
            <div id="CourseNoLabel" class="labeldiv" style="width:80px;">Course No:</div>
            <div id="CourseNoField" class="fielddiv" style="width:150px">
                <asp:TextBox ID="CRSIDTxt" runat="server"  CssClass="readonly" ReadOnly="true" Width="140px"></asp:TextBox>
            </div>
        </div>

        <div style="float:left; width:100%; height:20px; margin-top:5px;">
            <div id="CourseDateLabel" class="labeldiv" style="width:80px;">Course Date:</div>
            <div id="CourseDateField" class="fielddiv" style="width:150px">
                <asp:TextBox ID="CRSDTTxt" runat="server"  CssClass="readonly" ReadOnly="true" Width="140px"></asp:TextBox>
            </div>
        </div>

        <div class="buttondiv">
            <img id='delete_course' src='/Images/deletenode.png' class='imgButton' alt="Remove Course" style='float:left;' title='Remove course' />
            <img id='edit_course' src='/Images/edit.png' class='imgButton' alt="Edit Course" style='float:left;' title='Edit course' />
        </div>
    </div>
    ...
    <asp:Panel ID="panel2" runat="server" CssClass="modalPanel" style="z-index: 10!important;">
        ...
        <div id="AccommodationGroupHeader" class="groupboxheader" style=" margin-top:10px;">Accommodation</div>
        <div style="float:left; width:100%; height: 20px; margin-top:7px">
            
            <div id="AccommodationGroupField" class="groupbox" style="height:30px; width:auto;">
            <div id="LunchLabel" class="labeldiv" style="border-right:0px;">Including Lunch:</div>
            <div id="LunchField" class="fielddiv" style="width:20px; border-right:1px solid #052556">
                <input type="checkbox" id="LNCHCHK" class="checkbox" />
            </div>

            <div id="RefreshmentsLabel" class="labeldiv" style="border-right:0px;">Including Refreshments:</div>
            <div id="RefreshmentsField" class="fielddiv" style="width:20px; border-right:1px solid #052556">
                <input type="checkbox" id="REFCHK" class="checkbox" />
            </div>
            
            
            <div id="TransportationLabel" class="labeldiv" style="border-right:0px;">Including Transportation:</div>
            <div id="TransportationField" class="fielddiv" style="width:20px; border-right:1px solid #052556">
                                ...
                                $.ajax(
                                {
                                    ...
                                    success: function (data)
                                    {
                                        ...
                                        if (data)
                                        {
                                            ...
                                            var startdate = new Date(course.attr('StartDate'));
                                            startdate.setMinutes(startdate.getMinutes() + startdate.getTimezoneOffset());

                                            var enddate = new Date(course.find("EndDate").text());
                                            enddate.setMinutes(enddate.getMinutes() + enddate.getTimezoneOffset());

                                            $("#<%=CRSIDTxt.ClientID%>").val(course.attr('CourseNo'));

                                            if (course.find("EndDate").text() == '') {
                                                $("#<%=CRSDTTxt.ClientID%>").val(startdate.format("dd/MM/yyyy"));
                                            }
                                            else {
                                                $("#<%=CRSDTTxt.ClientID%>").val(startdate.format("dd/MM/yyyy") + " To " + enddate.format("dd/MM/yyyy"));
                                            }
    ...
    function bindCourseData(data)
    {
        ...
        if (course != null)
        {
            ...
            if (course.attr('Description') != '' && course.attr('Description') != null)
            {
                ...
                $("#<%=DESCTxt.ClientID%>").val($("#<%=DESCTxt.ClientID%>").html(course.attr('Description')).text());
            }
            else
            {
            ...
            $("#<%=STDTTxt.ClientID%>").val(startdate.format("dd/MM/yyyy"));
            $("#<%=ENDDTTxt.ClientID%>").val(course.find("EndDate").text() == '' ? '' : enddate.format("dd/MM/yyyy"));
            ...
            if (course.attr('Notes') != '' && course.attr('Notes') != null) {
                ...
                $("#<%=RMKTxt.ClientID%>").val($("#<%=RMKTxt.ClientID%>").html(course.attr('Notes')).text());
            }
            else {
