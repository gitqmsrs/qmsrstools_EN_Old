...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        <img id="emailrefresh" src="http://www.qmsrs.com/qmsrstools/Images/refresh.png" class="imgButton" title="" alt="" />
        <img id="newEmail" src="http://www.qmsrs.com/qmsrstools/Images/new_file.png" class="imgButton" title="" alt=""/>   
    </div>
    ...
    <div id="EmailScrollbar" class="gridscroll">
    ...
    <asp:Panel ID="panel1" runat="server" CssClass="modalPanel">
        ...
        <div id="validation_dialog_email">
