...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        <img id="new" src="http://www.qmsrs.com/qmsrstools/Images/new_file.png" class="imgButton" title="Create new document file type" alt=""/>   
...
<script type="text/javascript" language="javascript">
    ...
    function loadGridView(data, empty) {
        ...
        $(xml).find("DocFileType").each(function (index, value) {
            ...
            $("td", row).eq(2).html("<img id='icon_" + index + "' src='http://www.qmsrs.com/qmsrstools/ImageHandler.ashx?query=select Icon from DocumentList.DocumentFileType where DocumentFileTypeID=" + $(this).attr('DocFileTypeID') + "&width=20&height=20&date=" + date.getSeconds() + "' />");
