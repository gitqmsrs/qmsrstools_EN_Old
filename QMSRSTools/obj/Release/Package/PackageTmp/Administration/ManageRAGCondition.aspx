...
<div id="wrapper" class="modulewrapper">
    <div id="MNGRAG_Header" class="moduleheader">Manage Red, Amber, and Green Indicators</div>

    <div class="toolbox">
        <img id="conditionrefresh" src="http://www.qmsrs.com/qmsrstools/Images/refresh.png" class="imgButton" title="" alt="" />
        <img id="newcondition" src="http://www.qmsrs.com/qmsrstools/Images/new_file.png" class="imgButton" title="" alt=""/>    
...
<script type="text/javascript" language="javascript">
    ...
    function loadGridView(empty, data) {
        ...
        $(xmlConditions).find('RAGCondition').each(function (index, value) {
            ...
            $("td", row).eq(2).html("<img id='icon_" + index + "' src='http://www.qmsrs.com/qmsrstools/ImageHandler.ashx?query=select RAGIcon from dbo.RAGConditionSymbol where RAGSymbol=@value&width=20&height=20&value=" + $(this).attr('RAG') + "&date=" + date.getSeconds() + "' />");
