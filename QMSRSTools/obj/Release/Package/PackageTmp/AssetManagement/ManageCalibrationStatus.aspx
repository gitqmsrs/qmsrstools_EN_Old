<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site2.Master" AutoEventWireup="true" Culture = "en-GB" CodeBehind="ManageCalibrationStatus.aspx.cs" Inherits="QMSRSTools.AssetManagement.ManageCalibrationStatus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div id="wrapper" class="modulewrapper">
    <div id="CalibrationStatus_Header" class="moduleheader">Manage Calibration Status</div>
    
    <div class="toolbox">
        <img id="newstatus" src="http://www.qmsrs.com/qmsrstools/Images/new_file.png" class="imgButton" title="Create new asset calibration status" alt=""/>  
        <img id="refreshstatus" src="http://www.qmsrs.com/qmsrstools/Images/refresh.png" class="imgButton" title="Refresh Data" alt="" />
    </div>

    <div id="CALISTSloader" class="loader">
    ...
    <div id="header" class="modalHeader">Calibration Status Details<span id="close" class="modalclose" title="Close">X</span></div>
        ...
        <div style="float:left; width:100%; height:20px; margin-top:15px;">
            ...
            <asp:RequiredFieldValidator ID="STSNMVal" runat="server" Display="None" ControlToValidate="STSNMTxt" ErrorMessage="Enter the name of the calibration status" ValidationGroup="General"></asp:RequiredFieldValidator> 
...
<script type="text/javascript" language="javascript">
                    ...
                    $("#SaveTooltip").stop(true).hide().fadeIn(500, function () {
                        ...
                        if ($("#MODE").val() == 'ADD') {
                            ...
                            $.ajax(
                            {
                                ...
                                dataType: "json",
                                data: "{\'json\':\'" + JSON.stringify(status) + "\'}",
                                url: getServiceURL().concat('updateCalibrationStatus'),
                                success: function (data)
                                {
                                    $("#SaveTooltip").fadeOut(500, function () {
                                        ActivateSave(true);
    ...
    {
        var result = confirm("Are you sure you would like to remove the current asset calibration status record?");
        if (result == true)
        {
           ...
           $.ajax(
           {
               ...
               dataType: "json",
               data: "{'ID':'" + ID + "'}",
               url: getServiceURL().concat("removeCalibrationStatus"),
               success: function (data)
               {
    ...
    {
        $("#CALISTSloader").stop(true).hide().fadeIn(500, function () {
            $(".modulewrapper").css("cursor", "wait");
            ...
            $.ajax(
            {
                ...
                success: function (data) {
                    $("#CALISTSloader").fadeOut(500, function () {
                        $(".modulewrapper").css("cursor", "default");
                                ...
                                if ($(this).attr('id').search('delete') != -1) {
                                    ...
                                    $(this).bind('click', function ()
                                    {
                                        ...
                                        if ($(value).attr("Description") == '') {
                                            /*attach description to limit plugin*/
                                            addWaterMarkText('The description of the calibration status', '#<%=DESCTxt.ClientID%>');
                                        }
                                        else {
