<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site2.Master" AutoEventWireup="true" Culture = "en-GB" CodeBehind="ManageMaintenanceStatus.aspx.cs" Inherits="QMSRSTools.AssetManagement.ManageMaintenanceStatus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div id="wrapper" class="modulewrapper">
    <div id="MaintenanceStatus_Header" class="moduleheader">Manage Maintenance Status</div>
    
    <div class="toolbox">
        <img id="newstatus" src="http://www.qmsrs.com/qmsrstools/Images/new_file.png" class="imgButton" title="Create new asset maintenance status" alt=""/>  
        <img id="refreshstatus" src="http://www.qmsrs.com/qmsrstools/Images/refresh.png" class="imgButton" title="Refresh Data" alt="" />
    </div>

    <div id="MAINTSTSloader" class="loader">
    ...
    <div id="header" class="modalHeader">Maintenance Status Details<span id="close" class="modalclose" title="Close">X</span></div>
        ...
        <div style="float:left; width:100%; height:20px; margin-top:15px;">
            ...
            <asp:RequiredFieldValidator ID="STSNMVal" runat="server" Display="None" ControlToValidate="STSNMTxt" ErrorMessage="Enter the name of the maintenance status" ValidationGroup="General"></asp:RequiredFieldValidator>
...
<script type="text/javascript" language="javascript">
    ...
    $(function () {
        ...
        $("#newstatus").bind('click', function () 
        {
            ...
            addWaterMarkText('The description of the maintainance status', '#<%=DESCTxt.ClientID%>');
                    ...
                    $("#SaveTooltip").stop(true).hide().fadeIn(500, function () {
                        ...
                        if ($("#MODE").val() == 'ADD') {
                            ...
                            $.ajax(
                            {
                                ...
                                dataType: "json",
                                data: "{\'json\':\'" + JSON.stringify(status) + "\'}",
                                url: getServiceURL().concat('updateMaintenanceStatus'),
                                success: function (data)
                                {
                                    $("#SaveTooltip").fadeOut(500, function () {
                                        ActivateSave(true);
    ...
    {
        var result = confirm("Are you sure you would like to remove the current asset maintenance status record?");
        if (result == true)
        {
           ...
           $.ajax(
           {
               ...
               dataType: "json",
               data: "{'ID':'" + ID + "'}",
               url: getServiceURL().concat("removeMaintenanceStatus"),
               success: function (data)
               {
    ...
    function refresh(empty) {
        $("#MAINTSTSloader").stop(true).hide().fadeIn(500, function () {
            $(".modulewrapper").css("cursor", "wait");
            ...
            $.ajax(
            {
                ...
                success: function (data) {
                    $("#MAINTSTSloader").fadeOut(500, function () {
                        $(".modulewrapper").css("cursor", "default");
