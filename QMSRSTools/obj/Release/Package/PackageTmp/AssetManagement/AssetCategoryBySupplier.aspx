...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div id="AssetSupplierContainer" class="filter" style=" display:block;">
        <div id="AssetSupplierLabel" class="filterlabel">Asset Supplier:</div>
        <div id="AssetSupplierField" class="filterfield">
