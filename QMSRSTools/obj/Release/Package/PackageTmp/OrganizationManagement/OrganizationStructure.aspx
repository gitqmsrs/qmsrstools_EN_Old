...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        <img id="save" src="http://www.qmsrs.com/qmsrstools/Images/save.png" alt="" title="Save Changes" class="imgButton" />
        <img id="refresh" src="http://www.qmsrs.com/qmsrstools/Images/refresh.png" alt="Refresh Data"  class="imgButton"/>
        <img id="delete" src="http://www.qmsrs.com/qmsrstools/Images/deletenode.png" alt="Remove Unit" class="imgButton" />

        <div id="new_div">
            <img id="new" src="http://www.qmsrs.com/qmsrstools/http://www.qmsrs.com/qmsrstools/Images/new_file.png" alt=""/>
