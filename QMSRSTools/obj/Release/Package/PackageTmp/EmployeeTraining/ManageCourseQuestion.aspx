...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <img id="new" src="http://www.qmsrs.com/qmsrstools/Images/new_file.png" class="imgButton" title="Add New Course Question" alt="" />  
    ...
    <asp:Panel ID="panel2" runat="server" CssClass="modalPanel" style="height:450px;">
        ...
        <div style="float:left; width:100%; height:20px; margin-top:10px;">
            ...
            <img id="AddQuestion" src="http://www.qmsrs.com/qmsrstools/Images/add.png" class="imgButton" title="Add New Question" alt="" /> 
        ...
        <div id="CreateQuestionGroupField" class="groupbox" style="height:260px; display:none;">
            ...
            <img id="SaveQUS" src="http://www.qmsrs.com/qmsrstools/Images/save.png" class="imgButton" title="Save Changes" alt="" style="display:none;"/>
                
            <img id="SaveQUSWIMG" src="http://www.qmsrs.com/qmsrstools/Images/wait-loader.gif" alt="Save" height="25" width="25" style="display:none;" />
