...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <img id="new" src="http://www.qmsrs.com/qmsrstools/Images/new_file.png" class="imgButton" title="Add New Course Session" alt="" />  
    ...
    <div id="SearchCourse" class="selectbox">
        ...
        <div class="toolbox">
            <img id="refreshcourses" src="http://www.qmsrs.com/qmsrstools/Images/refresh.png" class="imgButton" title="Refresh Data" alt="" />
    ...
    <div id="VenueOption" class="optionbox" style="top:110px;">
        ...
        <div class="buttondiv">
            <img id='delete_venue' src='http://www.qmsrs.com/qmsrstools/Images/deletenode.png' class='imgButton' alt="Remove venue schedule" style='float:left;' title='Remove course' />
            <img id='edit_venue' src='http://www.qmsrs.com/qmsrstools/Images/edit.png' class='imgButton' alt="Edit venue schedule" style='float:left;' title='Edit course' />
        </div>
    </div>
    ...
    <asp:Panel ID="panel2" runat="server" CssClass="modalPanel">
        ...
        <div class="tabcontent" style="height:500px; margin-top:10px; display:block;">
            ...
            <div style="float:left; width:100%; height:20px; margin-top:10px;">
                ...
                <span id="AddVenue" class="searchactive" style="margin-left:10px; background: url(http://www.qmsrs.com/qmsrstools/Images/add.png)" title="Add New Venue" /> 
            ...
            <div id="LocationGroupField" class="groupbox" style="height:260px; display:none;">
                ...
                <img id="SaveLOC" src="http://www.qmsrs.com/qmsrstools/Images/save.png" class="imgButton" title="Save Changes" alt="" style="display:none;"/>
                
                <img id="SaveLOCWIMG" src="http://www.qmsrs.com/qmsrstools/Images/wait-loader.gif" alt="Save" height="25" width="25" style="display:none;" />
...
<script type="text/javascript" language="javascript">
        $(function () {
            ...
            $("#<%=INSTRCBox.ClientID%>").change(function () {
                if ($(this).val() != 0) {
                    $("#<%=INSTRTxt.ClientID%>").val($(this).val());
