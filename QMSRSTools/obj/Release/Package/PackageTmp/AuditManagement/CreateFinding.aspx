    ...
    <div id="FindingGroupField" class="groupbox" style="height:520px;">
        ...
        <div id="DetailsTB" class="tabcontent" style="display:none; height:450px;">
            ...
            <div style="float:left; width:100%; height:20px; margin-top:15px;">
                ...
                <img id="FNDTYPADD" class="imgButton" src="http://www.qmsrs.com/qmsrstools/Images/add.png" style="margin-left:2px" runat="server" title="Create a new finding type" alt=""/>
        ...
        <div id="CausesTB" class="tabcontent" style="display:none; height:450px;">
            <div class="toolbox">
                ...
                <img id="delete" src="http://www.qmsrs.com/qmsrstools/Images/deletenode.png" alt="" class="imgButton" title="Remove Cause"/>
