        ...
        <div style="float:left; width:100%; height:20px; margin-top:10px;">
            ...
            <div id="CausesTB" class="tabcontent" style="display:none; height:450px;">
                <div class="toolbox">
                    ...
                    <img id="delete" src="http://www.qmsrs.com/qmsrstools/Images/deletenode.png" alt="" class="imgButton" title=""/>
                    <img id="new" src="http://www.qmsrs.com/qmsrstools/Images/new_file.png" alt="" class="imgButton" title=""/> 
    ...
    function loadFindingGridView(data, empty)
    {
        ...
        $(xmlAudits).find('AuditRecord').each(function (i, audit)
        {
            ...
            $(xmlFinding).find("AuditFinding").each(function (index, finding) {
                ...
                $("td", row).eq(9).html($(audit).attr("ModeString"));
