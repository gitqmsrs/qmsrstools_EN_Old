...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <img id="new" src="http://www.qmsrs.com/qmsrstools/Images/new_file.png" class="imgButton" title="Create New Subcategory" alt=""/>  
        <img id="refresh" src="http://www.qmsrs.com/qmsrstools/Images/refresh.png" alt=""  class="imgButton" title="Refresh Data"/>
        <img id="delete" src="http://www.qmsrs.com/qmsrstools/Images/deletenode.png" class="imgButton" title="Remove Selected Subcategory" alt=""/>
    </div>
    ...
    <div id="SearchCategory" class="selectbox">
        <div class="toolbox">
            <img id="refreshcategories" src="http://www.qmsrs.com/qmsrstools/Images/refresh.png" class="imgButton" alt="" title="Refresh Categories"/>
            ...
            if (isTreeFieldValid)
            {
                ...
                if (node != null && node != false)
                {
                    ...
                    else
                    {
                        ...
                        $("#<%=SUBCATDESCTxt.ClientID%>").html(node.Description).text();
                    }
