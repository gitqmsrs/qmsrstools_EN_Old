    ...
    <div id="scrollbar" class="gridscroll">
        ...
        <div id="RAGTooltip" class="tooltip" style="margin-top:20px; background-color:transparent;">
            <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
                <img id="RED" src="http://www.qmsrs.com/qmsrstools/Images/Red.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Red: Problem has passed target close date.</p>
            </div>
        
            <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
                <img id="GREEN" src="http://www.qmsrs.com/qmsrstools/Images/Green.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Green: Problem is on schedule.</p>
            </div>
            <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
                <img id="AMBER" src="http://www.qmsrs.com/qmsrstools/Images/Amber.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Amber: Problem will be overdue soon.</p>
            </div>
        </div>	
    ...
    <asp:Panel ID="panel1" runat="server" CssClass="modalPanel">
        ...
        <div id="DetailsTB" class="tabcontent" style="display:none; height:450px;">
            ...
            <div id="SearchCustomer" class="selectbox" style="width:600px; height:250px; top:130px; left:80px;">
                <div class="toolbox">
                    <img id="party_delete_filter" src="http://www.qmsrs.com/qmsrstools/Images/filter-delete-icon.png" class="imgButton" alt=""/>
                    <div id="party_filter_div">
                        <img id="party_filter" src="http://www.qmsrs.com/qmsrstools/Images/filter.png" alt=""/>
                        <ul class="contextmenu">
...
<script type="text/javascript" language="javascript">
    ...
    function loadGridView(data, empty)
    {
        ...
        $(xml).find("Problem").each(function (index, value)
        {
            ...
            $("td", row).eq(0).html("<img id='icon_" + index + "' src='http://www.qmsrs.com/qmsrstools/RAGHandler.ashx?module=" + $(this).attr('ModuleName') + "&key=" + $(this).attr('ProblemID') + "&width=20&height=20&date=" + date.getSeconds() + "' />");
            ...
            $("td", row).eq(8).html($(this).find("OriginationDate").text() == '' ? '' : new Date($(this).find("OriginationDate").text()).format("dd/MM/yyyy"));
            $("td", row).eq(9).html(new Date($(this).attr("TargetCloseDate")).format("dd/MM/yyyy"));
            $("td", row).eq(10).html($(this).find("ActualCloseDate").text() == '' ? '' : new Date($(this).find("ActualCloseDate").text()).format("dd/MM/yyyy"));
