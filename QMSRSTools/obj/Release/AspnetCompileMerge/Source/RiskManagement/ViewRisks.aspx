      ...
      <div class="toolbox">
        ...
        <div id="filter_div">
            ...
            <ul class="contextmenu">
                 <li id="byName">Filter by Risk Name</li>
        ...
        <div id="RiskNameContainer" class="filter" style=" float:left;width:270px; margin-left:10px; height:20px; margin-top:3px; display:none;">
            <div id="RiskNameLabel" style="width:100px;">Risk Name Keyword:</div>
            <div id="RiskNameField" style="width:150px; left:0; float:left;">
                <asp:TextBox ID="RSKNMTxt" runat="server" CssClass="textbox" Width="140px"></asp:TextBox>
            </div>
        </div>
