...
<div id="wrapper" class="modulewrapper">
    ...
    <asp:Panel ID="panel1" runat="server" CssClass="modalPanel">
        ...
        <ul id="tabul">
            ...
            <li id="Mitigation" class="ntabs">Risk Mitigation</li>
        </ul>
        ...
        <div id="DetailsTB" class="tabcontent" style="display:none; height:460px;">
            ...
            <div style="float:left; width:100%; height:20px; margin-top:15px;">
                ...
                <asp:CompareValidator ID="DUDTF3Val" runat="server" ControlToCompare="REGDTTxt"
                ControlToValidate="DUDTTxt" ErrorMessage="Due date should be greater than or equals the registeration date"  ValidationGroup="Details"
            ...
            <div style="float:left; width:100%; height:20px; margin-top:15px;">
                ...
                ControlToValidate="DTASSDTTxt" ErrorMessage="Due date should be greater than or equals the registeration date"  ValidationGroup="Details"
                Operator="GreaterThanEqual" Type="Date"
                Display="None"></asp:CompareValidator>
        ...
        <div id="MitigationTB" class="tabcontent" style="display:none; height:460px;">

            <div id="validation_dialog_mitigation" style="display: none">
                <asp:ValidationSummary ID="ValidationSummary2" runat="server" CssClass="validator" ValidationGroup="Mitigation" />
            </div>
            ...
            <div style="float:left; width:100%; height:20px; margin-top:10px;">
                ...
                <div id="PotentialImpactField" class="fielddiv" style="width:400px;">
                    <asp:TextBox ID="POTIMPCTTxt" runat="server" CssClass="textbox" Width="390px" Height="90px" TextMode="MultiLine"></asp:TextBox>
                </div>

                <asp:CustomValidator id="POTIMPCTTxtFVal" runat="server" ValidationGroup="Mitigation" 
                ControlToValidate = "POTIMPCTTxt" Display="None" ErrorMessage = "Characters !@$%^*+=[]{}|<> are not allowed"
                ClientValidationFunction="validateSpecialCharactersLongText">
                </asp:CustomValidator>
            </div>
            ...
            <div style="float:left; width:100%; height:20px; margin-top:92px;">
                ...
                <div id="CountermeasuresField" class="fielddiv" style="width:400px;">
                    <asp:TextBox ID="CMESRTxt" runat="server" CssClass="textbox" Width="390px" Height="90px" TextMode="MultiLine"></asp:TextBox>
                </div>

                <asp:CustomValidator id="CMESRTxtFVal" runat="server" ValidationGroup="Mitigation" 
                ControlToValidate = "CMESRTxt" Display="None" ErrorMessage = "Characters !@$%^*+=[]{}|<> are not allowed"
                ClientValidationFunction="validateSpecialCharactersLongText">
                </asp:CustomValidator>
            </div>

            <div style="float:left; width:100%; height:20px; margin-top:92px;">
                <div id="ActionsLabel" class="labeldiv">Actions:</div>
                <div id="ActionsField" class="fielddiv" style="width:400px;">
                    <asp:TextBox ID="ACTDSCRTxt" runat="server" CssClass="textbox" Width="390px" Height="90px" TextMode="MultiLine"></asp:TextBox>
                </div>

                <asp:CustomValidator id="ACTDSCRFVal" runat="server" ValidationGroup="Mitigation" 
                ControlToValidate = "ACTDSCRTxt" Display="None" ErrorMessage = "Characters !@$%^*+=[]{}|<> are not allowed"
                ClientValidationFunction="validateSpecialCharactersLongText">
                </asp:CustomValidator>
            </div>

            <div style="float:left; width:100%; height:20px; margin-top:92px;">
                <div id="ActioneeLabel" class="labeldiv">Actionee:</div>
...
<input id="EMPMODE" type="hidden" value="" />
...
<script type="text/javascript" language="javascript">
    ...
    $(function ()
    {
        ...
        {
            /*set employee mode to actionee*/
            $("#EMPMODE").val('Actionee');
            showORGDialog(e.pageX, e.pageY);
        });
            ...
            if (isDetailsValid)
            {
                ...
                if (isRiskEstimationValue)
                {
                    ...
                    var risk =
                    {
                        ...
                        PotentialImpact: $("#<%=POTIMPCTTxt.ClientID%>").hasClass("watermarktext") == true ? '' : escapeHtml($("#<%=POTIMPCTTxt.ClientID%>").val()),
                        Countermeasures: $("#<%=CMESRTxt.ClientID%>").hasClass("watermarktext") == true ? '' : escapeHtml($("#<%=CMESRTxt.ClientID%>").val()),
                        Actions: $("#<%=ACTDSCRTxt.ClientID%>").hasClass("watermarktext") == true ? '' : escapeHtml($("#<%=ACTDSCRTxt.ClientID%>").val()),
                        Actionee: ($("#<%=ACTEECBox.ClientID%>").val() == 0 || $("#<%=ACTEECBox.ClientID%>").val() == null ? '' : $("#<%=ACTEECBox.ClientID%>").val()),
                        ProjectName: '',
                        TimeImpact: '',
                        CostImpact: '',
                        QOSImpact: '',
                        ...
                        case "ORI":
                            ...
                            if (isRiskValid) {
                                ...
                                $("#validation_dialog_risk").stop(true).hide().fadeIn(500, function () {
                                    alert("Please make sure that all warnings in the probability TAB are fulfilled");
                                    navigate('Probability');
                                });
                            }
    ...
    function loadGridView(data, empty)
    {
        ...
        $(xmlRisks).find("Risk").each(function (index, value)
        {
            ...
            $("td", row).eq(7).html(new Date($(this).attr("RegisterDate")).format("dd/MM/yyyy"));
            $("td", row).eq(8).html($(this).find("ClosureDate").text() == '' ? '' : new Date($(this).find("ClosureDate").text()).format("dd/MM/yyyy"));
                    ...
                    $(this).bind('click', function ()
                    {
                        ...
                        */
                        ...
                        else
                        {
                            ...
                            $("#<%=RSKDESCTxt.ClientID%>").html($(value).attr("Description")).text();
                        }

                        /*bind register date*/
                        $("#<%=REGDTTxt.ClientID%>").val(new Date($(value).attr("RegisterDate")).format("dd/MM/yyyy"));

                        /*bind due date*/
                        $("#<%=DUDTTxt.ClientID%>").val($(value).find("DueDate").text() == '' ? '' : new Date($(value).find("DueDate").text()).format("dd/MM/yyyy"));

                        /*bind assessed date*/
                        $("#<%=DTASSDTTxt.ClientID%>").val($(value).find("AssessedDate").text() == '' ? '' : new Date($(value).find("AssessedDate").text()).format("dd/MM/yyyy"));

                        /*bind closure date*/
                        $("#<%=CLSRDTTxt.ClientID%>").val($(value).find("ClosureDate").text() == '' ? '' : new Date($(value).find("ClosureDate").text()).format("dd/MM/yyyy"));

                        /*bind potential impact value*/
                        if ($(value).attr("PotentialImpact") == '')
                        {

                            addWaterMarkText('The description of the potential impact', '#<%=POTIMPCTTxt.ClientID%>');
                        }
                        else
                        {
                            if ($("#<%=POTIMPCTTxt.ClientID%>").hasClass("watermarktext")) {
                                $("#<%=POTIMPCTTxt.ClientID%>").val('').removeClass("watermarktext");
                            }

                            $("#<%=POTIMPCTTxt.ClientID%>").html($(value).attr("PotentialImpact")).text();
                        }

                        /*bind countermeasures value*/
                        if ($(value).attr("Countermeasures") == '')
                        {

                            addWaterMarkText('The description of the countermeasures', '#<%=CMESRTxt.ClientID%>');
                        }
                        else {
                            if ($("#<%=CMESRTxt.ClientID%>").hasClass("watermarktext")) {
                                $("#<%=CMESRTxt.ClientID%>").val('').removeClass("watermarktext");
                            }

                            $("#<%=CMESRTxt.ClientID%>").html($(value).attr("Countermeasures")).text();
                        }

                        /*bind actions value*/
                        if ($(value).attr("Actions") == '') {

                            addWaterMarkText('The description of the risk actions', '#<%=ACTDSCRTxt.ClientID%>');
                        }
                        else {
                            if ($("#<%=ACTDSCRTxt.ClientID%>").hasClass("watermarktext")) {
                                $("#<%=ACTDSCRTxt.ClientID%>").val('').removeClass("watermarktext");
                            }

                            $("#<%=ACTDSCRTxt.ClientID%>").html($(value).attr("Countermeasures")).text();
                        }

                        /*bind actionee*/
                        bindComboboxAjax('loadEmployees', '#<%=ACTEECBox.ClientID%>', $(value).attr("Actionee"), "#ACTEMP_LD");
