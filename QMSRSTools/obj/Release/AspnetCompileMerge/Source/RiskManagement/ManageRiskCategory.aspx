...
<div id="wrapper" class="modulewrapper">
    ...
    <div id="SearchCategory" class="selectbox" style="width:700px; height:250px; top:85px; left:150px;">
        <div class="toolbox">
        ...
        <div id="CategoryScroll" style="height:200px; width:100%; overflow:auto; margin-top:15px; float:left">
...
<script type="text/javascript" language="javascript">
    $(function ()
    {
        ...
        $("#<%=CATSelect.ClientID%>").bind('click', function ()
        {
            $("#SearchCategory").show();
            loadRiskCategories(categoryempty);
        });
