...
<div id="wrapper" class="modulewrapper">
    ...
    <div id="RiskGroupField" class="groupbox" style="height:520px;">
        ...
        <div id="ProbabilityTB" class="tabcontent" style="display:none; height:480px;">
            ...
            <div id="RiskGeneralEstimationGroup" class="groupbox" style="height:auto;">
                ...
                <div id="SearchProject" class="selectbox" style="width:700px; height:250px; top:190px; left:165px;">
                    <div class="toolbox">
                ...
                <div style="float:left; width:100%; height:20px; margin-top:15px;">
                    ...
                    <img id="TIMPEdit" src="../Images/edit.png" class="imgButton" alt="" title="Edit Time Impact Criteria"/>
                ...
                <div style="float:left; width:100%; height:20px; margin-top:15px;">
                    ...
                    <img id="CIMPEdit" src="../Images/edit.png" class="imgButton" alt="" title="Edit Cost Impact Criteria"/>
                ...
                <div style="float:left; width:100%; height:20px; margin-top:15px;">
                    ...
                    <img id="QOSIMPEdit" src="../Images/edit.png" class="imgButton" alt="" title="Edit Quality of Service Criteria"/>
        ...
        <div id="MitigationTB" class="tabcontent" style="display:none; height:480px;">
            <div style="float:left; width:100%; height:20px; margin-top:10px;">
                <div id="PotentialImpactLabel" class="labeldiv">Potential Impact:</div>
                <div id="PotentialImpactField" class="fielddiv" style="width:400px; height:125px;">
                    <asp:TextBox ID="POTIMPCTTxt" runat="server" CssClass="textbox" Width="390px" Height="120px" TextMode="MultiLine"></asp:TextBox>
                </div>

                <asp:CustomValidator id="POTIMPCTTxtFVal" runat="server" ValidationGroup="Impact" 
            ...
            <div style="float:left; width:100%; height:20px; margin-top:122px;">
                ...
                <div id="CountermeasuresField" class="fielddiv" style="width:400px; height:125px;">
                    <asp:TextBox ID="CMESRTxt" runat="server" CssClass="textbox" Width="390px" Height="120px" TextMode="MultiLine"></asp:TextBox>
                </div>

                <asp:CustomValidator id="CMESRTxtFVal" runat="server" ValidationGroup="Impact" 
    ...
    <asp:Panel ID="RateCriteriaPanel" runat="server" CssClass="modalPanel">
        ...
        <div class="toolbox">
            <img id="newrate" src="../Images/new_file.png" class="imgButton" title="Create New Significant Rate Criteria" alt=""/> 
        </div>
            ...
            $.ajax(
            {
                ...
                success: function (data) {
                    ...
                    if (!$("#<%=POTIMPCTTxt.ClientID%>").hasClass("watermarktext")) {
                        addWaterMarkText('Enter the description of the potential impact', '#<%=POTIMPCTTxt.ClientID%>');
                    }
