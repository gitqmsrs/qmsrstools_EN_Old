...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <img id="new" src="../Images/new_file.png" class="imgButton" title="Add New Formula" alt=""/>    
        ...
        <div id="RiskTypeContainer" class="filter" style=" float:left;width:310px; margin-left:10px; height:20px; margin-top:3px; display:none;">
            <div id="RiskTypeFilterLabel" style="width:100px;">Risk Type:</div>
            <div id="RiskTypeFilterField" style="width:150px; left:0; float:left;">
                <asp:DropDownList ID="RSKTYPFCBox" runat="server" Width="150px" CssClass="combobox">
                </asp:DropDownList>
            </div>
    ...
    <div id="FormulaScrollbar" style="height:78%; width:96%; overflow:auto; margin-top:15px; float:left">
    ...
    <asp:Panel ID="panel2" runat="server" CssClass="modalPanel" style="height:550px;">
        ...
        <div id="validation_dialog_formula" style="display: none">
