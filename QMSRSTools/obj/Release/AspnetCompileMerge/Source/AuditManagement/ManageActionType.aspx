<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site2.Master" Culture = "en-GB" AutoEventWireup="true" CodeBehind="ManageActionType.aspx.cs" Inherits="QMSRSTools.AuditManagement.ManageActionType" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div id="wrapper" class="modulewrapper">
       
    <div id="ActionType_Header" class="moduleheader">Manage Audit Action Type</div>
    
    <div class="toolbox">
        <img id="newtype" src="../Images/new_file.png" class="imgButton" title="Create new action type" alt=""/>  
    ...
    <div id="scrollbar" style="height:250px; width:96%; height:78%; overflow:auto; margin-top:15px; float:left">
    ...
    <div id="header" class="modalHeader">Action Type Details<span id="close" class="modalclose" title="Close">X</span></div>
        ...
        <div style="float:left; width:100%; height:20px; margin-top:15px;">
            ...
            <asp:RequiredFieldValidator ID="ACTTYPTxtVal" runat="server" Display="None" ControlToValidate="ACTTYPTxt" ErrorMessage="Enter the type of the audit action" ValidationGroup="General"></asp:RequiredFieldValidator>  
        </div>
...
<script type="text/javascript" language="javascript">
    ...
    $(function () {
        ...
        $("#newtype").bind('click', function () {
            ...
            $("#<%=ACTTYPTxt.ClientID%>").limit({ id_result: 'ACTTYPlimit', alertClass: 'alertremaining', limit: 50 });
                    ...
                    $("#SaveTooltip").stop(true).hide().fadeIn(500, function ()
                    {
                        ...
                        if ($("#MODE").val() == 'ADD')
                        {
                            ...
                            $.ajax(
                            {
                                ...
                                url: getServiceURL().concat('createAuditActionType'),
                        ...
                        else if ($("#MODE").val() == 'EDIT')
                        {
                            ...
                            $.ajax(
                            {
                                ...
                                dataType: "json",
                                data: "{\'json\':\'" + JSON.stringify(actiontype) + "\'}",
                                url: getServiceURL().concat('updateAuditActionType'),
                                success: function (data)
                                {
                                    $("#SaveTooltip").fadeOut(500, function () {
                                        ActivateSave(true);
    ...
    function removeActionType(ID, empty)
    {
        ...
        if (result == true)
        {
            ...
            $.ajax(
            {
                ...
                url: getServiceURL().concat("removeAuditActionType"),
                success: function (data)
                {
                            ...
                            $(row).find('img').each(function () {
                                ...
                                else if ($(this).attr('id').search('edit') != -1)
                                {
                                    $(this).bind('click', function ()
                                    {
                                        ...
                                        /*trigger action type keyup event*/
                                        $("#<%=ACTTYPTxt.ClientID%>").keyup();

                                        /*trigger description keyup event*/
                                        $('#<%=DESCTxt.ClientID%>').keyup();
