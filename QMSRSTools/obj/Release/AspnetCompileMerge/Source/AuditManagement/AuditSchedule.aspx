...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <div id="AuditYearContainer" class="filter" style=" float:left;width:310px; margin-left:10px; height:20px; margin-top:3px; display:none;">
            <div id="AuditYearLabel" style="width:100px;">Audit Year:</div>
            <div id="AuditYearField" style="width:170px; left:0; float:left;">
                <asp:DropDownList ID="AUDTYRCBox" AutoPostBack="false" runat="server" Width="140px" CssClass="comboboxfilter">
                </asp:DropDownList>
            </div>
            <div id="ADTFYR_LD" class="control-loader"></div>
        </div>
        ...
        <div id="AuditTypeContainer" class="filter" style=" float:left; width:310px; margin-left:10px; height:20px; margin-top:3px; display:none;">
            ...
            <div id="AuditTypeFilterField" style="width:170px; left:0; float:left;">
                <asp:DropDownList ID="AUDTTYPFCBox" AutoPostBack="false" runat="server" Width="130px" CssClass="comboboxfilter">
                </asp:DropDownList>
            </div>
        ...
        <div id="RecordModeContainer" class="filter" style=" float:left;width:310px; margin-left:10px; height:20px; margin-top:3px; display:none;">
            ...
            <div id="ADTFRM_LD" class="control-loader"></div>
        </div>
    ...
    <div id="RAGTooltip" class="tooltip" style="margin-top:20px; background-color:transparent;"> 
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="RED" src="../Images/Red.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Red: The audit is overdue.</p>
        </div>
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="GREEN" src="../Images/Green.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Green: The audit is on schedule.</p>
        </div>
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="AMBER" src="../Images/Amber.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Amber: The audit has been delayed.</p>
        </div>
    </div>	


    <div id="auditloader" style="margin-top:20px;display:none;">
    ...
    <asp:Panel ID="panel1" runat="server" CssClass="modalPanel">
        ...
        <div id="AuditTooltip" class="tooltip">
        ...
        <div id="DetailsTB" class="tabcontent" style="display:none; height:450px;">
            ...
            <div style="float:left; width:100%; height:20px; margin-top:15px;">
                ...
                <div id="ProgressField" class="fielddiv" style="width:150px">
                    <asp:TextBox ID="PROGRSSTxt" runat="server" CssClass="date" Width="140px" placeholder="dd/mm/yyyy"></asp:TextBox>
                </div>
        ...
        <div id="ORGUnitsTB" class="tabcontent" style="display:none;height:450px;">
            <div style="float:left; width:100%; height:20px; margin-top:15px;">
                <div id="LocationLabel" class="labeldiv">Filter by Location:</div>
                <div id="LocationField" class="fielddiv" style="width:250px">
            ...
            <div id="orgtreemenu" class="menucontainer" style="border: 1px solid #052556; margin-top:10px; height:390px;width:27%;">   
                <div id="waitloader">
                    <div class="waittext">Please Wait...</div>
                    </div>
                <div id="orgtree"></div>
            </div>
            <div id="orgtreeconstraint" class="modulecontainer" style="border: 1px solid #052556; margin-top:10px;height:390px;width:67%;">
        ...
        <div id="ScopeSummeryTB" class="tabcontent" style="display:none;height:450px;">
            ...
            <div id="validation_dialog_scopesummery" style="display: none">
...
<script type="text/javascript" language="javascript">
    $(function ()
    {
        ...
        {
            hideAll();
            loadComboboxAjax('enumAuditYears', "#<%=AUDTYRCBox.ClientID%>", "#ADTFYR_LD");
        ...
        $("#byRECMOD").bind('click', function () {
            ...
            /*load record mode*/
            loadComboboxAjax('loadRecordMode', "#<%=RECMODCBox.ClientID%>","#ADTFRM_LD");
        });
        ...
        $("#<%=PROGRSSTxt.ClientID%>").keyup(function ()
        {
            ...
            {
                $("#<%=AUDTSTSCBox.ClientID%>").val('InProgress');
            }
                    ...
                    if (result == true) {
                        ...
                        $("#SaveTooltip").stop(true).hide().fadeIn(500, function () {
                            ...
                            var audit =
                            {
                                ...
                                Supplier: ($("#supplier").is(":hidden") == true || $("#<%=SUPPCBox.ClientID%>").val() == 0 || $("#<%=SUPPCBox.ClientID%>").val() == null ? '' : $("#<%=SUPPCBox.ClientID%>").val()),
                                Project: ($("#project").is(":hidden") == true || $("#<%=PROJCBox.ClientID%>").val() == 0 || $("#<%=PROJCBox.ClientID%>").val() == null ? '' : $("#<%=PROJCBox.ClientID%>").val()),
                                Completed: $("#<%=PROGRSSTxt.ClientID%>").val(),
                                CheckLists: getChecklistJSON(),
                                Units: $("#table").table('getJSON'),
                                AuditStatus: $("#<%=AUDTSTSCBox.ClientID%>").val(),
    ...
    function loadUnits(data) {
        ...
        $(units).find('ORGUnit').each(function (index, value) {
            $("#table").table('addRow',
            {
                ORGID: $(value).attr('ORGID'),
                name: $(value).attr('name'),
                ORGLevel: $(value).attr('ORGLevel'),
    ...
    function filterByMode(mode, year)
    {
        $("#auditloader").stop(true).hide().fadeIn(500, function ()
        {
            ...
            $.ajax(
            {
                ...
                url: getServiceURL().concat('filterByMode'),
                success: function (data) {
    ...
    function bindAuditRecord(data,matrix)
    {
        ...
        $(xml).find('AuditRecord').each(function (index, audit)
        {
            ...
            sb.append("<img id='delete_" + index + "' src='../Images/deletenode.png' class='imgButton' style='float:left;' title='Remove audit record'/>");
            sb.append("<img id='edit_" + index + "' src='../Images/edit.png' class='imgButton' style='float:left;' title='Edit audit Record'/>");
            sb.append("<img id='report_" + index + "' src='../Images/report.png' class='imgButton' style='float:left;' title='View report' />");
            ...
            $("#edit_" + index).bind('click', function ()
            {
                ...
                $("#<%=PROCDOCTxt.ClientID%>").val($(audit).attr('ProcessDocument'));
                ...
                {
                    $("#AuditTooltip").find('p').text("Changes cannot take place since the audit status is " + $(audit).attr('AuditStatusString'));

                    if ($("#AuditTooltip").is(":hidden")) {
                        $("#AuditTooltip").slideDown(800, 'easeOutBounce');
                    }
