...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <div id="CourseTitleContainer" class="filter" style=" float:left;width:310px; margin-left:10px; height:20px; margin-top:3px; display:none;">
            <div id="CourseTitleFLabel" style="width:100px;">Course Title:</div>
            <div id="CourseTitleFField" style="width:170px; left:0; float:left;">
                <asp:DropDownList ID="CTTLFCBox" AutoPostBack="false" runat="server" Width="150px" CssClass="comboboxfilter">
                </asp:DropDownList>
            </div>
    ...
    <asp:Panel ID="panel2" runat="server" CssClass="modalPanel">
        ...
        <div id="AccommodationGroupHeader" class="groupboxheader" style=" margin-top:20px;">Accommodation</div>
        <div id="AccommodationGroupField" class="groupbox" style="height:30px;">
...
<script type="text/javascript" language="javascript">
    ...
    function bindCourseData(data)
    {
        ...
        if (course != null)
        {
            ...
            if (course.attr("IncludeLunch") == 'true') {
                $("#<%=LNCHCHK.ClientID%>").prop('checked', true);
            }
            else {
            ...
            if (course.attr("IncludeRefreshment") == 'true') {
                $("#<%=REFCHK.ClientID%>").prop('checked', true);
            }
            else {
            ...
            if (course.attr("IncludeTransporation") == 'true') {
                $("#<%=TRNSCHK.ClientID%>").prop('checked', true);
            }
            else {
    ...
    {
        $("#SelectDOCTYP").css({ left: x - 300, top: y - 90 });
