...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="tabcontent" style="  margin-top:10px; height:600px;">
        ...
        <div style="float:left; width:100%; height:20px; margin-top:122px;">
            ...
            ControlToValidate = "STDTTxt" Display="None" ErrorMessage = "Start date of the course should be greater than or equals today's date"
...
<script type="text/javascript" language="javascript">
        $(function ()
        {
            ...
            addWaterMarkText('The description of the course in no more than 300 characters', '#<%=DESCTxt.ClientID%>');

            loadComboboxAjax('loadPeriod', "#<%=COURSPRDCBox.ClientID%>", "#COURSPRD_LD");

            /*attach course ID to limit plugin*/
            $("#<%=CRSIDTxt.ClientID%>").limit({ id_result: 'IDlimit', alertClass: 'alertremaining', limit: 100 });
                    ...
                    if (result == true) {
                        ...
                        $.ajax(
                        {
                            ...
                            success: function (data) {
                                ...
                                /*trigger course ID keyup event to reset the character limit*/
                                $("#<%=CRSIDTxt.ClientID%>").keyup();

                                /*trigger course title keyup event to reset the character limit*/
