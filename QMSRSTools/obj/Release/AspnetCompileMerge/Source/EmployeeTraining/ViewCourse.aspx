    ...
    <div class="toolbox">
        ...
        <div id="CourseTitleContainer" class="filter" style=" float:left;width:270px; margin-left:10px; height:20px; margin-top:3px; display:none;">
            ...
            <div id="CourseTitleFField" style="width:150px; left:0; float:left;">
                <asp:TextBox ID="CTTLTxt" runat="server" CssClass="filtertext" Width="140px"></asp:TextBox>
            </div>
        </div>

        <div id="CourseStatusContainer" class="filter" style=" float:left;width:310px; margin-left:10px; height:20px; margin-top:3px; display:none;">
        ...
        <div id="AttendanceStatusContainer" class="filter" style=" float:left;width:310px; margin-left:10px; height:20px; margin-top:3px; display:none;">
            <div id="AttendanceStatusLabel" style="width:100px;">Attendance Status:</div>
            <div id="AttendanceStatusField" style="width:170px; left:0; float:left;">
                <asp:DropDownList ID="ATTSTSCBox" AutoPostBack="false" runat="server" Width="150px" CssClass="comboboxfilter">
                </asp:DropDownList>
            </div>
        ...
        <div id="StartdateContainer" class="filter" style="float:left; width:450px;margin-left:10px; height:20px; margin-top:3px;display:none;">
            <div id="StartDateLabel" style="width:120px;">Start Date:</div>
...
<script type="text/javascript" language="javascript">
        ...
        function loadGridView(data, empty) {
            ...
            $(xmlCourses).find("Course").each(function (index, value) {
                $("td", row).eq(0).html("<img id='schedule_" + index + "' src='../Images/schedule.jpg' class='imgButton' title='View course timetable' />");
                $("td", row).eq(1).html("<img id='delete_" + index + "' src='../Images/deletenode.png' class='imgButton' title='Withdraw from this course' />");
                $("td", row).eq(2).html("<img id='feedback_" + index + "' src='../Images/feedback.jpg' class='imgButton' title='Add feedback for this course'/>");
