...
<div id="wrapper" class="modulewrapper">
    ...
    <div id="scrollbarQuestion" style="height:78%; width:96%; overflow:auto; margin-top:15px; float:left">
    ...
    <asp:Panel ID="panel2" runat="server" CssClass="modalPanel" style="height:450px;">
         <div id="CourseQuestion_Details" class="modalHeader">Participant Details<span id="close" class="modalclose" title="Close">X</span></div>
        ...
        <div id="CreateQuestionGroupField" class="groupbox" style="height:260px; display:none;">
            ...
            <div id="validation_dialog_new" style="display: none">
