...
<div id="wrapper" class="modulewrapper">
    ...
    <div id="SearchCourse" class="selectbox" style="width:700px; height:250px; top:40px; left:150px;">
        ...
        <div id="scrollbar" style="height:200px; width:100%; overflow:auto; margin-top:15px; float:left">
    ...
    <asp:Panel ID="panel2" runat="server" CssClass="modalPanel">
        ...
        <div class="tabcontent" style="height:500px; margin-top:10px;">
            ...
            <div id="Employee" style="float:left; width:100%; height:20px; margin-top:15px; display:none;">
            ...
            <div id="External" style="float:left; width:100%; height:20px; margin-top:15px; display:none;">
            ...
            <div id="LocationGroupField" class="groupbox" style="height:260px; display:none;">
                ...
                <div id="validation_dialog_venue" style="display: none">
