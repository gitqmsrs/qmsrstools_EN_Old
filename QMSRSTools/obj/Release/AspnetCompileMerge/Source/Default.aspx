...
<div id="wrapper" class="modulewrapper">
    ...
    <div id="menu" class="menucontainer">
        <div class="toolbox">
            <img id="mainrefresh" src="../Images/refresh.png" class="imgButton" title="Refresh Modules" alt="" />
            <img id="visio" src="../Images/visio.jpg" class="imgButton" title="Maintain Visio Diagrams" alt="" />
        </div>
    ...
    <asp:Panel ID="panel1" runat="server" CssClass="modalPanel">
        ...
        <div class="tabcontent" style="height:450px; margin-top:15px;">
        <div class="toolbox">
            <img id="refreshlist" src="../Images/refresh.png" alt="" title="Refresh Visio Diagrams" class="imgButton"/>
            <img id="delete" src="../Images/deletenode.png" alt="" title="Remove Visio Diagram" class="imgButton" />
            <img id="new" src="Images/new_file.png" alt="" title="Add Visio Diagram" class="imgButton" />
        </div>
  
        <div id="visiotreemenu" class="menucontainer" style="border: 1px solid #052556; overflow:auto; height:440px; width:35%;">
        ...
        <div id="visiotreefield" class="modulecontainer" style="border: 1px solid #052556; overflow:auto; height:440px; width:63%;">
    ...
    <asp:Panel ID="LoadPanel" CssClass="savepanel" runat="server" style="display:none">
...
<script type="text/javascript" language="javascript">
    ...
    {
        $('#pagecontainer').show();
        $('#pagecontainer').attr("src", 'Visio/Process.aspx?source=' + getURL().concat('VisioDiagrams/Business_Model.vsd'));
    }
