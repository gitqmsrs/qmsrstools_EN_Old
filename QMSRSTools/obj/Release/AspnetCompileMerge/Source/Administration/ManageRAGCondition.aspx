...
<div id="wrapper" class="modulewrapper">
    <div id="MNGRAG_Header" class="moduleheader">Manage RAG Condition</div>
    ...
    <div class="toolbox">
        ...
        <div id="ModuleContainer" class="filter" style=" float:left;width:310px; margin-left:10px; height:20px; margin-top:3px; display:none;">
            <div id="ModuleFilterLabel" style="width:100px;">Module:</div>
            <div id="ModuleFilterField" style="width:170px; left:0; float:left;">
                <asp:DropDownList ID="MDLFLTRCBox" runat="server" Width="150px" CssClass="combobox">
                </asp:DropDownList>
            </div>
            <div id="MODULF_LD" class="control-loader"></div>
        </div>

        <div id="RAGContainer" class="filter" style=" float:left;width:310px; margin-left:10px; height:20px; margin-top:3px; display:none;">
            <div id="RAGFilterLabel" style="width:100px;">RAG Symbol:</div>
            <div id="RAGFilterField" style="width:170px; left:0; float:left;">
                <asp:DropDownList ID="RAGFLTRCBox" runat="server" Width="150px" CssClass="combobox">
                </asp:DropDownList>
            </div> 
...
<div id="RAGScrollbar" style="height:78%; width:96%; overflow:auto; margin-top:15px; float:left">
...
<asp:Panel ID="panel2" runat="server" CssClass="modalPanel" style="height:550px;">
    ...
    <div id="validation_dialog_condition" style="display: none">
    ...
    <div style="float:left; width:100%; height:20px; margin-top:15px;">
        ...
        <div id="SelectRAGField" class="fielddiv" style="width:250px;">
            <asp:DropDownList ID="RAGCBox" AutoPostBack="false" Width="230px" runat="server" CssClass="combobox">
            </asp:DropDownList> 
        </div>
