...
<div id="wrapper" class="modulewrapper">
    ...
    <div style="float:left; width:100%; height:20px; margin-top:15px;">
        ...
        <span id="ISOADD" class="addnew" style="" runat="server" title="Create new ISO Standard"></span>
    ...
    <div id="SearchStandard" class="selectbox" style="width:700px; height:250px; top:85px; left:150px;">
        <div class="toolbox">
        ...
        <div id="STDScroll" style="height:200px; width:100%; overflow:auto; margin-top:15px; float:left">
    ...
    <asp:Panel ID="panel1" runat="server" CssClass="modalPanel" style="height:300px;">
        ...
        <div id="validation_dialog_standard" style="display: none">
    ...
    <div id="isoprocesstreemenu" class="menucontainer" style="border: 1px solid #052556; overflow:visible; margin-top:10px; height:400px;">
    ...
    <div id="isoprocessdatafield" class="modulecontainer" style="border: 1px solid #052556; overflow:visible; margin-top:10px; height:400px;">
...
<script type="text/javascript" language="javascript">
    $(function ()
    {
        ...
        $("#<%=ISOSelect.ClientID%>").bind('click', function () {
        ...
        $("#<%=ISOADD.ClientID%>").bind('click', function ()
        {
                ...
                if ($(this).attr('id').search('delete') != -1) {
                    ...
                    $(this).bind('click', function ()
                    {
                        ...
                        if ($(value).attr("Description") == '') {
                            ...
                            $("#<%=ISODESCTxt.ClientID%>").html($(value).attr("Description")).text();
                        }
