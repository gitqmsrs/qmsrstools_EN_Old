...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="SearchReview" class="selectbox" style="width:600px; height:250px; top:80px; left:150px;">
        <div class="toolbox">
            ...
            <div id="ReviewtStatusContainer" class="filter" style=" float:left;width:270px; margin-left:10px; height:20px; margin-top:3px; display:none;">
            ...
            <div id="ReviewCategoryContainer" class="filter" style=" float:left;width:270px; margin-left:10px; height:20px; margin-top:3px; display:none;">
                <div id="ReviewCategoryFLabel" style="width:100px;">Review Category:</div>
                <div id="ReviewCategoryFField" style="width:150px; left:0; float:left;">
            ...
            <div id="PlannedReviewDateContainer" class="filter" style="float:left; width:450px; height:20px; margin-top:4px; display:none;">
                <div id="PlannedReviewDateLabel" style="width:120px;">Planned Review Date:</div>
                <div id="PlannedReviewDateField" style="width:270px; left:0; float:left;">
    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            ...
            $("#<%=FDTTxt.ClientID%>").datepicker(
           {
            ...
            $("#<%=REVIDSRCH.ClientID%>").bind('click', function () {
                refreshManagementReviews(empty);
                $("#SearchReview").show();
            });
                        ...
                        $.ajax(
                           {
                               ...
                               success: function (data) {
                                   $("#REVID_LD").fadeOut(500, function () {
                                       ...
                                       if ($(review).attr('ReviewStatus') == 'Completed') {
                                           alert("Cannot create an action on a task which is related to a completed management review");

                                           reset();
                                           ActivateAll(false);
                                       }
                                       else if ($(review).attr('ReviewStatus') == 'Cancelled') {

                                           alert("Cannot create an action on a task which is related to a cancelled management review");
                                           ...
                                           if ($(tasks).find("ReviewTask").length > 0) {
                                               ...
                                               alert("There are no tasks for the current management review record in order to create an action");
                                               reset();
        ...
        function loadGridView(data, empty) {
            ...
            $(xml).find("Review").each(function (index, value) {
                ...
                $("td", row).eq(1).html(new Date($(this).attr("PlannedReviewDate")).format("dd/MM/yyyy"));
                $("td", row).eq(2).html($(this).find("ActualReviewDate").text() == '' ? '' : new Date($(this).find("ActualReviewDate").text()).format("dd/MM/yyyy"));
                $("td", row).eq(3).html($(this).find("ActualCloseDate").text() == '' ? '' : new Date($(this).find("ActualAuditDate").text()).format("dd/MM/yyyy"));
                $("td", row).eq(4).html($(this).attr("ReviewStatus"));
