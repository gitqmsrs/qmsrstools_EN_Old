                        ...
                        $.ajax(
                        {
                            ...
                            success: function (data)
                            {
                                $("#REVID_LD").fadeOut(500, function () {
                                    ...
                                    {
                                        alert("Cannot create a task on a completed management review");

                                        ActivateAll(false);
                                    }
                                    else if ($(review).attr('ReviewStatus') == 'Cancelled')
                                    {
                                        alert("Cannot create a task on a cancelled management review");
                                    ...
                                    else
                                    {
                                        ...
                                        $("#reviewdate").val($(this).attr('PlannedReviewDate'));

                                        ActivateAll(true);

                                        /*attach name of the task to limit plugin*/
                                        $('#<%=TSKNMTxt.ClientID%>').limit({ id_result: 'TSKlimit', alertClass: 'alertremaining', limit: 100 });
