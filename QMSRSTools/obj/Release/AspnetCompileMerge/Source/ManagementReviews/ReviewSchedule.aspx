    ...
    <asp:Panel ID="panel2" runat="server" CssClass="modalPanel">
        ...
        <div id="ORGUnitsTB" class="tabcontent" style="display:none;height:470px;">
            <div class="toolbox">
                ...
                <div id="Div1">
                    <img id="Img1" src="../Images/filter.png" alt=""/>
                    <ul class="contextmenu">
                ...
                <div id="LocationContainer" class="filterunit" style=" float:left;width:270px; margin-left:10px; height:20px; margin-top:3px; display:none;">
            ...
            <div id="orgtreemenu" class="menucontainer" style="border: 1px solid #052556; margin-top:10px; height:440px; width:30%;">   
                <div id="REVloader" class="loader">
                    <div class="waittext">Please Wait...</div>
                </div>
                <div id="orgtree"></div>
            </div>
            <div id="datafield" class="modulecontainer" style="border: 1px solid #052556; margin-top:10px;height:440px; width:68%;">
...
<script type="text/javascript" language="javascript">
        ...
        {
            if(unitExists(selected.name))
            {
                alert("The name of the organization unit already exists in the list");
            }
            else
            {
        ...
        function bindReviewData(data)
        {
            ...
            if (review != null)
            {
                ...
                loadUnits(review.attr('XMLUnits'));
        ...
        function hideAllUnitFilter() {
            $(".filterunit").each(function () {
                $(this).css('display', 'none');
            });
        }
</script>
