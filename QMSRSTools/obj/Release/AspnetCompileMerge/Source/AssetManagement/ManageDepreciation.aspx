...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <img id="new" src="../Images/new_file.png" class="imgButton" title="Add New Depreciation Record" alt=""/>
    </div>
    ...
    <div id="scrollbar" style="height:78%; width:100%; overflow:auto; margin-top:15px; float:left">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Amount" HeaderText="Deprecitaion Amount" />
            <asp:BoundField DataField="DEPDate" HeaderText="Depreciation Date" />
        </Columns>
        </asp:GridView>
    </div>
...
<script type="text/javascript" language="javascript">
        $(function ()
        {
                        ...
                        if (result == true) {
                            ...
                            $("#SaveTooltip").stop(true).hide().fadeIn(500, function () {
                                ...
                                if ($("#MODE").val() == 'ADD') {
                                    var depreciation =
                                    {
                                        DepreciationAmount: Math.round($("#<%=DEPAMNTTxt.ClientID%>").val()),
                                    ...
                                    var depreciation =
                                    {
                                        ...
                                        DepreciationAmount: $("#<%=DEPAMNTTxt.ClientID%>").val(),
                                        DepreciationDate: new Date(depdatepart[2], (depdatepart[1] - 1), depdatepart[0]),
                                        Currency: $("#<%=DEPCURRTxt.ClientID%>").val()
                                    }
            ...
            $("#new").bind('click', function ()
            {
                if ($("#assetJSON").val() != '')
                {
                    ...
                    {
                        alert("The sum depreciation must be less than the current value of the asset");
                    }
                }
                else
                {
                        ...
                        $.ajax(
                        {
                            ...
                            success: function (data) {
                                $("#Asset_LD").fadeOut(500, function ()
                                {
                                    ...
                                    loadDepreciationGridView(asset.attr('XMLDepreciation'), depempty);
                                });
                            },
                            error: function (xhr, status, error)
                            {
        ...
        function calculateTotalDepreciation()
        {
            ...
            {
                total += parseFloat($("td", $(this)).eq(2).html());
            });
        ...
        function loadDepreciationGridView(data,empty)
        {
            ...
            $(xmlDepreciation).find("Depreciation").each(function (index, value)
            {
                ...
                $("td", row).eq(2).html($(this).attr("DepreciationAmount") + " " + $(this).attr("Currency"));
                $("td", row).eq(3).html(new Date($(this).attr("DepreciationDate")).format('dd/MM/yyyy'));
                ...
                $(row).find('img').each(function ()
                {
                    if ($(this).attr('id').search('edit') != -1)
                    {
                        $(this).bind('click', function ()
                        {
                            ...
                            $("#<%=DEPDTTxt.ClientID%>").val(new Date($(value).attr("DepreciationDate")).format('dd/MM/yyyy'));
                ...
                $.ajax(
                {
                    ...
                    success: function (data) {
                        $("#DEPWait").fadeOut(500, function () {
                            ...
                            loadDepreciationGridView(asset.attr('XMLDepreciation'), empty);
                        });
                    },
                    error: function (xhr, status, error) {
                        $("#DEPWait").fadeOut(500, function () {
