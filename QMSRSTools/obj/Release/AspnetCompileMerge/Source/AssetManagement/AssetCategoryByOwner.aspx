...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="toolbox">
        <div id="AssetSupplierContainer" class="filter" style=" float:left;width:270px; margin-left:10px; height:20px; margin-top:3px;">
            <div id="AssetOwnerLabel" style="width:100px;">Asset Owner:</div>
            <div id="AssetOwnerField" style="width:150px; left:0; float:left;">
                <asp:DropDownList ID="ASSTOWNRCBox" AutoPostBack="true" runat="server" Width="150px" CssClass="combobox" OnSelectedIndexChanged="ASSTOWNRCBox_SelectedIndexChanged">
                </asp:DropDownList>
            </div>
        </div>
     </div>
