...
<div id="wrapper" class="modulewrapper">
    ...
    <asp:Panel ID="panel1" runat="server" CssClass="modalPanel" style="height:610px;">
        ...
        <div id="DetailsTB" class="tabcontent" style="display:none; height:500px;">
        ...
        <div id="PurchaseTB" class="tabcontent" style="display:none; height:500px;">
            ...
            <div style="float:left; width:100%; height:20px; margin-top:15px;">
                ...
                ControlToValidate="ACQDTTxt" ErrorMessage="Acquisition date should be greater than or equals the purchase date"
            ...
            <div id="OwnerTB" class="tabcontent" style="display:none; height:500px;">
                ...
                $.ajax(
                {
                    ...
                    success: function (data) {
                        $("#AssetTooltip").stop(true).hide().fadeIn(800, function () {
                            ...
                            $(this).find('p').text("List of assets purchased between " + startdate.format("dd/MM/yyyy") + " and " + enddate.format("dd/MM/yyyy"));
                ...
                $.ajax(
                {
                    ...
                    success: function (data) {
                        $("#ASSTwait").fadeOut(500, function () {
                            ...
                            $("#AssetTooltip").stop(true).hide().fadeIn(800, function () {
                                $(this).find('p').text("List of assets installed between " + startdate.format("dd/MM/yyyy") + " and " + enddate.format("dd/MM/yyyy"));
                            });
                            loadGridView(data.d, empty);
                        });
            ...
            $.ajax(
            {
                ...
                success: function (data) {
                    ...
                    $("#ASSTwait").fadeOut(500, function () {
                        ...
                        $("#AssetTooltip").stop(true).hide().fadeIn(800, function () {
                            $(this).find('p').text("List of assets filtered by organization unit");
                        });
                ...
                success: function (data) {
                    ...
                    $("#ASSTwait").fadeOut(500, function () {
                        ...
                        $("#AssetTooltip").stop(true).hide().fadeIn(800, function () {
                            ...
                            $(this).find('p').text("List of assets filtered by their category");
                        });
                ...
                success: function (data) {
                    ...
                    $("#ASSTwait").fadeOut(500, function ()
                    {
                        ...
                        $("#AssetTooltip").stop(true).hide().fadeIn(800, function ()
                        {
                            ...
                            $(this).find('p').text("List of assets filtered by their mode");
                        });
            ...
            $.ajax(
            {
                ...
                success: function (data) {
                    ...
                    $("#ASSTwait").fadeOut(500, function ()
                    {
                        ...
                        $("#AssetTooltip").stop(true).hide().fadeIn(800, function ()
                        {
                            $(this).find('p').text("List of assets filtered by their status");
                        });
            ...
            $.ajax(
            {
                ...
                success: function (data)
                {
                    $("#ASSTwait").fadeOut(500, function ()
                    {
                        ...
                        $("#AssetTooltip").stop(true).hide().fadeIn(800, function ()
                        {
                            $(this).find('p').text("List of assets purchased in the current year");
                        });
