...
<div id="wrapper" class="modulewrapper">
    ...
    <div id="PurchaseTB" class="tabcontent" style="display:none; height:520px;">
        ...
        <div id="validation_dialog_purchase" style="display: none">
       ...
       <div style="float:left; width:100%; height:20px; margin-top:15px;">
        ...
        <div style="float:left; width:100%; height:20px; margin-top:15px;">
            <div id="ExternalPurchaseOrderLabel" class="labeldiv">External Purchase Order:</div>
            <div id="ExternalPurchaseOrderField" class="fielddiv" style="width:250px">
        ...
        <div style="float:left; width:100%; height:20px; margin-top:15px;">
            ...
            <asp:CompareValidator ID="ACQDTTxtF1Val" runat="server" ControlToCompare="PURDTTxt"  ValidationGroup="Purchase"
            ControlToValidate="ACQDTTxt" ErrorMessage="Acquisition date should be less than or equals purchase date"
    ...
    <div id="OwnerTB" class="tabcontent" style="display:none; height:520px;">
        <div id="validation_dialog_owner" style="display: none">
        ...
        <div style="float:left; width:100%; height:20px; margin-top:15px;">
            <div id="RoomLabel" class="requiredlabel">Room:</div>
            ...
            <asp:RequiredFieldValidator ID="ROOMTxtVal" runat="server" Display="None" ControlToValidate="ROOMTxt" ErrorMessage="Enter room number" ValidationGroup="Owner"></asp:RequiredFieldValidator>  
       ...
       <div style="float:left; width:100%; height:20px; margin-top:15px;">
            <div id="FloorLabel" class="requiredlabel">Floor:</div>
            ...
            <asp:RequiredFieldValidator ID="FLOORTxtVal" runat="server" Display="None" ControlToValidate="FLOORTxt" ErrorMessage="Enter floor number" ValidationGroup="Owner"></asp:RequiredFieldValidator>   
    ...
    <div id="LifecycleTB" class="tabcontent" style="display:none; height:520px;">
        ...
        <div id="validation_dialog_lifecycle" style="display: none">
        ...
        <div style="float:left; width:100%; height:20px; margin-top:15px;">
            ...
            <div id="HasCalibrationField" class="fielddiv" style="width:250px">
                <asp:CheckBox ID="CALICHK" runat="server" AutoPostBack="false" CssClass="checkbox" />
            </div>
        </div>
        ...
        <div style="float:left; width:100%; height:20px; margin-top:15px;">
            ...
            <div id="MaintenanceField" class="fielddiv" style="width:250px">
                <asp:CheckBox ID="MAINTCHK" runat="server" AutoPostBack="false" CssClass="checkbox" />
            </div>
        </div>
       ...
       <div style="float:left; width:100%; height:20px; margin-top:15px;">
            ...
            <div id="HasElectricalTestField" class="fielddiv" style="width:250px">
                <asp:CheckBox ID="ELCTSTCHK" runat="server" AutoPostBack="false" CssClass="checkbox" />
            </div>
        </div>
    ...
    <asp:Panel ID="StatusPanel" runat="server" CssClass="modalPanel" style="height:300px;">
        ...
        <div id="AssetStatusSaveTooltip" class="tooltip">
         ...
         <div id="validation_dialog_status" class="validationcontainer" style="display: none">
    ...
    <asp:Panel ID="CategoryPanel" runat="server" CssClass="modalPanel" style="height:300px;">
       ...
       <div id="validation_dialog_category" class="validationcontainer" style="display: none">
    ...
    <asp:Panel ID="BillingPanel" runat="server" CssClass="modalPanel" style="height:300px;">
       ...
       <div id="validation_dialog_billing" class="validationcontainer" style="display: none">
    ...
    <asp:Panel ID="AcquisitionPanel" runat="server" CssClass="modalPanel" style="height:300px;">
        <div id="ACQ_header" class="modalHeader">Create New Acquisition Method<span id="ACQclose" class="modalclose" title="Close">X</span></div>
            ...
            <div id="validation_dialog_acquisition" class="validationcontainer" style="display: none">
        ...
        <asp:Panel ID="DepreciationPanel" runat="server" CssClass="modalPanel" style="height:300px;">
            ...
            <div id="validation_dialog_depreciation" class="validationcontainer" style="display: none">
    ...
    <script type="text/javascript" language="javascript">
        $(function ()
        {
                    ...
                    if (result == true) {
                        $("#BillingCategorySaveTooltip").stop(true).hide().fadeIn(500, function () {
                            ...
                            var category =
                            {
                                ...
                                Description: $("#<%=BCATDESCTxt.ClientID%>").hasClass("watermarktext") == true ? '' : $("#<%=BCATDESCTxt.ClientID%>").val()
                            }
            ...
            $("#<%=CALICHK.ClientID%>").change(function ()
            {
            ...
            $("#<%=MAINTCHK.ClientID%>").change(function ()
            {
                if ($(this).is(":checked") == true)
                {
            ...
            $("#<%=ELCTSTCHK.ClientID%>").change(function ()
            {
                if ($(this).is(":checked") == true)
                {
                            ...
                            if (isAdditionalValid)
                            {
                                ...
                                if (result == true) {
                                    ...
                                    var asset =
                                    {
                                        ...
                                        HasCalibration: $("#<%=CALICHK.ClientID%>").is(':checked'),
                                        HasMaintenance: $("#<%=MAINTCHK.ClientID%>").is(':checked'),
                                        HasElectricalTest: $("#<%=ELCTSTCHK.ClientID%>").is(':checked'),
                                    ...
                                    $.ajax(
                                    {
                                        ...
                                        success: function (data)
                                        {
                                            ...
                                            $("#<%=CALICHK.ClientID%>").prop('checked', false);
                                            $("#<%=MAINTCHK.ClientID%>").prop('checked', false);
                                            $("#<%=ELCTSTCHK.ClientID%>").prop('checked', false);
