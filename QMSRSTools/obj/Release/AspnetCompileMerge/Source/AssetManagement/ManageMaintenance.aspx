...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <img id="new" src="../Images/new_file.png" class="imgButton" title="Add New Maintenance Record" alt=""/>
    </div>
    ...
    <div id="AssetScroll" style="height:200px; width:100%; overflow:auto; margin-top:15px; float:left">
            <asp:GridView id="gvAssets" runat="server" AutoGenerateColumns="false" CssClass="grid" GridLines="None" PageSize="10" AllowPaging="true" AlternatingRowStyle-CssClass="alt">
                <Columns>
                    ...
                    <asp:BoundField DataField="HasMaintenance" HeaderText="Has Maintenance" />
    ...
    <div id="AssetGroupField" class="groupbox" style="height:170px">
        ...
        <div id="validation_dialog_maintenancegroup" style="display: none">
    ...
    <div id="RAGTooltip" class="tooltip"  style="margin-top:20px; background-color:transparent;"> 
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="RED" src="../Images/Red.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Red: Asset is overdue for maintenance.</p>
        </div>
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="GREEN" src="../Images/Green.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Green: Asset will be due for maintenance.</p>
        </div>
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="AMBER" src="../Images/Amber.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Amber: Asset is not due for maintenance.</p>
        </div>
    </div>	
    ...
    <asp:Panel ID="panel2" runat="server" CssClass="modalPanel">
        <div id="header" class="modalHeader">Maintenance Details<span id="close" class="modalclose" title="Close">X</span></div>
            ...
            <div style="float:left; width:100%; height:20px; margin-top:15px;">
                ...
                <asp:CustomValidator id="MAINTDTF1Val" runat="server" ValidationGroup="General" 
                ControlToValidate = "MAINTDTTxt" Display="None" ErrorMessage = "Maintenance date should not be in future"
        ...
        <asp:Panel ID="MaintenanceStatusPanel" runat="server" CssClass="modalPanel" Style="height: 300px;">
            ...
            <div id="MaintenanceStatusSaveTooltip" class="tooltip">
             ...
             <div id="validation_dialog_maintenancestatus" style="display: none">
                            ...
                            success: function (data) {
                                $("#Asset_LD").fadeOut(500, function ()
                                {
                                    ...
                                    if (asset.attr('HasMaintenance') == 'false') {
                                        alert("Cannot create maintenance record since the current asset's maintenance settings has been disabled");
