...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <img id="new" src="../Images/new_file.png" class="imgButton" title="Add New Electrical Test Record" alt=""/>
    </div>
    ...
    <div id="AssetGroupField" class="groupbox" style="height:170px">
        ...
        <div id="validation_dialog_electricalgroup" style="display: none">
    ...
    <div id="RAGTooltip" class="tooltip"  style="margin-top:20px; background-color:transparent;"> 
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="RED" src="../Images/Red.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Red: Asset is overdue for electrical test.</p>
        </div>
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="GREEN" src="../Images/Green.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Green: Asset will be due for electrical test.</p>
        </div>
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="AMBER" src="../Images/Amber.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Amber: Asset is not due for electrical test.</p>
        </div>
    </div>	
    ...
    <asp:Panel ID="panel2" runat="server" CssClass="modalPanel">
       ...
       <div style="float:left; width:100%; height:20px; margin-top:15px;">
            ...
            <asp:CustomValidator id="ELECTRDTF1Val" runat="server" ValidationGroup="General" 
            ControlToValidate = "ELECTRDTTxt" Display="None" ErrorMessage = "Electrical test date should not be in future"
    ...
    <asp:Panel ID="ElectricalTestStatusPanel" runat="server" CssClass="modalPanel" Style="height: 300px;">
        ...
        <div id="validation_dialog_electricalstatus" style="display: none">
                        ...
                        $.ajax(
                        {
                            ...
                            success: function (data) {
                                $("#Asset_LD").fadeOut(500, function () {
                                    ...
                                    {
                                        alert("Cannot create electrical test record since the current asset's electrical test setting has been disabled");
