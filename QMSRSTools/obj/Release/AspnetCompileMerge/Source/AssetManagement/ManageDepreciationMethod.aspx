...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        <img id="newdepreciation" src="../Images/new_file.png" class="imgButton" title="Create new depreciation method" alt=""/>  
        <img id="refreshdepreciation" src="../Images/refresh.png" class="imgButton" title="Refresh Date" alt="" />
    </div>
