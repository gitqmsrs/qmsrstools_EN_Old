...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        <img id="newstatus" src="../Images/new_file.png" class="imgButton" title="Create new asset electrical test status" alt="" />
        <img id="refreshstatus" src="../Images/refresh.png" class="imgButton" title="Refersh data" alt="" />
    </div>
