    ...
    */
    ...
    JqTreeWidget = (function (_super) {
        ...
        JqTreeWidget.prototype.defaults = {
            ...
            autoEscape: true,
            dataUrl: null,
            closedIcon: '<img src="http://www.qmsrs.com/qmsrstools/Images/1375852118_toggle-expand.png" />',
            openedIcon: '<img src="http://www.qmsrs.com/qmsrstools/Images/1375852219_toggle.png" />',
            slide: true,
            nodeClass: Node
        };
        ...
        JqTreeWidget.prototype._refreshElements = function (from_node) {
            ...
            createFolderLi = function (node) {
                var button_html, button_classes, escaped_name, folder_classes, getButtonClasses, getFolderClasses;
                ...
                escaped_name = escapeIfNecessary(node.name);
                if (node.is_open) {
                    button_html = _this.options.openedIcon;
                } else {
                    button_html = _this.options.closedIcon;
                }
                return $("<li class=\"jqtree_common " + folder_classes + "\"><div class=\"jqtree-element jqtree_common\"><a class=\"jqtree_common " + button_classes + "\">" + button_html + "</a><span class=\"jqtree_common jqtree-title\">" + escaped_name + "</span></div></li>");
            };
