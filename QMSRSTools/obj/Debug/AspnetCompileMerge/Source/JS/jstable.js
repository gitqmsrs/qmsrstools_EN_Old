...
(function ($)
{
    var TableView = function($el, options) 
    {
        ...
        this.removeAll = function ()
        {
            ...
            $(this.control).children().not(':first').each(function (index, row)
            {
                $obj.removeRow($(this));
            });
        ...
        this.appendRow = function (index, value, obj) {
            ...
            sb.append("<img id='delete_" + index + "' src='http://www.qmsrs.com/qmsrstools/Images/cancel.png' alt='' class='row_img'/>");
            sb.append("</div>");
