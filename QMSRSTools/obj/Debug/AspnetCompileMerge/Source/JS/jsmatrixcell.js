...
(function ($)
{
    $.fn.matrixcell = function (obj, json, columnname, options)
    {
                    ...
                    form.submit(function (e) {
                        ...
                        if (false !== onsubmit.apply(form, [settings, cell])) {
                            ...
                            if (false !== submit.apply(form, [settings, cell])) {
                                ...
                                var coordinate = columnname.split("_");

                                $.each(json, function (i, value) {
                                    /*update the cell's value according to its x and y coordination in the matrix*/
                                    var x = parseInt(value["X"]);
                                    var y = parseInt(value["Y"]);
                                    if (x == parseInt(coordinate[0]) && y == parseInt(coordinate[1])) {
                                        if (value["Status"] != 3) {
                                            value["Status"] = 2;
                                        }

                                        value["Value"] = $(cell).html();
