...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <img id="delete" src="http://www.qmsrs.com/qmsrstools/Images/deletenode.png" class="imgButton" title="Remove Selected Cause" alt=""/>
    </div>

    <div id="causestreemenu" class="menucontainer" style="border: 1px solid #052556; width:25%; overflow:scroll; margin-top:10px;">
