...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        <img id="refreshauth" src="http://www.qmsrs.com/qmsrstools/Images/refresh.png" class="imgButton" title="Refresh Data" alt="" />
        <img id="newauth" src="http://www.qmsrs.com/qmsrstools/Images/new_file.png" class="imgButton" title="Create new user account" alt=""/>   
...
<script type="text/javascript" language="javascript">
    ...
    function loadGridView(data, empty) {
        ...
        $(xmlUsers).find('Users').each(function (i, user) {
            $("td", row).eq(0).html("<img id='delete_" + i + "' src='http://www.qmsrs.com/qmsrstools/Images/deletenode.png' class='imgButton'/>");
            $("td", row).eq(1).html("<img id='edit_" + i + "' src='http://www.qmsrs.com/qmsrstools/Images/edit.png' class='imgButton'/>");
