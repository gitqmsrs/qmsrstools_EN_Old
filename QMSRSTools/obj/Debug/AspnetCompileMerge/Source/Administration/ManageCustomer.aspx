...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <img id="newcustomer" src="http://www.qmsrs.com/qmsrstools/Images/new_file.png" class="imgButton" title="Create new party" alt=""/>  
    ...
    <asp:Panel ID="panel1" runat="server" CssClass="modalPanel">
        ...
        <div id="DetailsTB" class="tabcontent" style="display:none; height:450px;">
            ...
            <div id="SearchPartyType" class="selectbox">
                <div class="toolbox">
                    <img id="refreshTYP" src="http://www.qmsrs.com/qmsrstools/Images/refresh.png" class="imgButton" alt="" title="Refresh ISO Standards"/>
                ...
                <div id="PartyTypeContainer" class="filterselectbox" style="display:block;">
                    ...
                    <img id="Submit" src="http://www.qmsrs.com/qmsrstools/Images/find.png" class="imgButton" style="padding-top:1px;" title="Submit" alt="" /> 
