...
<div id="wrapper" class="modulewrapper">
    ...
    <div id="DetailsTB" class="tabcontent" style="display:none; height:480px;">
        ...
        <div id="organization" class="selectionfield" style="float:left; width:100%; height:20px; margin-top:15px; display:none;">
    ...
    <div id="CCNTB" class="tabcontent" style="display:none; height:480px;"> 
        ...
        <div style="float:left; width:100%; height:20px; margin-top:15px;">
            ...
            ControlToValidate = "ORGNDTTxt" Display="None" ErrorMessage = "Origination should not be in future"
