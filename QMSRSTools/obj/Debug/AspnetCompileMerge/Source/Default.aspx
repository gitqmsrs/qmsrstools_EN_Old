...
<div id="wrapper" class="modulewrapper">
    ...
    <div id="menu" class="menucontainer">
        <div class="toolbox">
            <img id="mainrefresh" src="http://www.qmsrs.com/qmsrstools/Images/refresh.png" class="imgButton" title="Refresh Modules" alt="" />
    ...
    <asp:Panel ID="panel1" runat="server" CssClass="modalPanel">
        ...
        <div class="toolbox">
            <img id="refreshlist" src="http://www.qmsrs.com/qmsrstools/Images/refresh.png" alt="" title="Refresh Visio Diagrams" class="imgButton"/>
            <img id="delete" src="http://www.qmsrs.com/qmsrstools/Images/deletenode.png" alt="" title="Remove Visio Diagram" class="imgButton" />
