...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        <img id="refresh" src="http://www.qmsrs.com/qmsrstools/Images/refresh.png" class="imgButton" alt="" title="Refresh Data" />
        <img id="new" src="http://www.qmsrs.com/qmsrstools/Images/new_file.png" class="imgButton" title="Add New Calibration Record" alt=""/>
    </div>
    ...
    <div class="toolbox">
        ...
        <img id="deletefilter" src="http://www.qmsrs.com/qmsrstools/Images/filter-delete-icon.png" class="selectBoxImg" alt=""/>
    ...
    <div id="AssetScroll" class="gridscroll">
            <asp:GridView id="gvAssets" runat="server" AutoGenerateColumns="false" CssClass="grid" GridLines="None" PageSize="10" AllowPaging="true" AlternatingRowStyle-CssClass="alt">
                <Columns>
                    ...
                    <asp:BoundField DataField="HasCalibration" HeaderText="Includes Calibration" />
    ...
    <div id="AssetGroupField" class="groupbox" style="height:170px">
        ...
        <img id="SaveGroup" src="http://www.qmsrs.com/qmsrstools/Images/save.png" class="imgButton" title="Save Changes" alt=""/>

        <div id="validation_dialog_calibrationgroup">
    ...
    <div id="RAGTooltip" class="tooltip"  style="margin-top:20px; background-color:transparent;"> 
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="RED" src="http://www.qmsrs.com/qmsrstools/Images/Red.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Red: Asset is overdue for calibration.</p>
        </div>
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="GREEN" src="http://www.qmsrs.com/qmsrstools/Images/Green.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Green: Asset is not due for calibration.</p>
        </div>
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="AMBER" src="http://www.qmsrs.com/qmsrstools/Images/Amber.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Amber: Asset will be due for calibration.</p>
        </div>
    </div>	
    ...
    <asp:Panel ID="CalibrationStatusPanel" runat="server" CssClass="modalPanel" style="height:300px;">
        ...
        <div id="validation_dialog_calibrationstatus">
                            ...
                            success: function (data)
                            {
                                $("#Asset_LD").fadeOut(500, function ()
                                {
                                    ...
                                    if (asset.attr('HasCalibration') == 'false') {
                                        alert("The calibration is not applicable for this particular asset since it has not been defined");
    ...
    function loadXMLPartyType(loader, control) {
        ...
        function loadCalibrations(data)
        {
            ...
            $(xmlCalibrations).find('AssetExtensions').each(function (index, value) {
                ...
                sb.append("<img id='delete_" + index + "' src='http://www.qmsrs.com/qmsrstools/Images/deletenode.png' class='imgButton' style='float:left;' title='Remove calibration'/>");
                sb.append("<img id='edit_" + index + "' src='http://www.qmsrs.com/qmsrstools/Images/edit.png' class='imgButton' style='float:left;' title='Edit calibration Record'/>");
                sb.append("<img id='RAG_" + index + "' src='http://www.qmsrs.com/qmsrstools/RAGHandler.ashx?module=" + $(this).attr('ModuleName') + "&key=" + $(this).attr('ExtensionID') + "&width=20&height=20&date=" + date.getSeconds() + "' class='imgButton' style='float:left;' title='RAG Status'/>");
