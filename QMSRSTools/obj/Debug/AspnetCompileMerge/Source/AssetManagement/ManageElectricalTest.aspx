...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <img id="new" src="http://www.qmsrs.com/qmsrstools/Images/new_file.png" class="imgButton" title="Add New Electrical Test Record" alt=""/>
    </div>
    ...
    <div id="RAGTooltip" class="tooltip"  style="margin-top:20px; background-color:transparent;"> 
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="RED" src="http://www.qmsrs.com/qmsrstools/Images/Red.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Red: Asset is overdue for electrical test.</p>
        </div>
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="GREEN" src="http://www.qmsrs.com/qmsrstools/Images/Green.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Green: Asset is not due for electrical test.</p>
        </div>
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="AMBER" src="http://www.qmsrs.com/qmsrstools/Images/Amber.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Amber: Asset will be due for electrical test.</p>
        </div>
    </div>	
        ...
        function loadTests(data) {
            ...
            $(xmlTests).find('AssetExtensions').each(function (index, value) {
                ...
                $("#edit_" + index).bind('click', function ()
                {
                    ...
                    /* bind test date*/
                    $("#<%=ELECTRDTTxt.ClientID%>").val(new Date($(value).attr('ExtensionDate')).format('dd/MM/yyyy'));

                    /* bind test due date*/
                    $("#<%=ELCDUEDTTxt.ClientID%>").val($(value).find("ExtensionDueDate").text() == '' ? '' : new Date($(value).find("ExtensionDueDate").text()).format("dd/MM/yyyy"));
