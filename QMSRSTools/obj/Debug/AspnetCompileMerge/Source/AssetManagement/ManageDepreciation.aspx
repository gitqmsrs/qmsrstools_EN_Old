...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <img id="new" src="http://www.qmsrs.com/qmsrstools/Images/new_file.png" class="imgButton" title="Add New Depreciation Record" alt=""/>
    </div>
    ...
    $(function () {
        ...
        function loadDepreciationGridView(data, empty) {
            ...
            $(xmlDepreciation).find("Depreciation").each(function (index, value)
            {
                ...
                $("td", row).eq(2).html(new Date($(this).attr("DepreciationDate")).format('dd/MM/yyyy'));
