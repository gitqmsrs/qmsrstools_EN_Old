...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <div id="filter_div">
            <img id="filter_icon" src="http://www.qmsrs.com/qmsrstools/Images/filter.png" alt=""/>
...
<script type="text/javascript" language="javascript">
    ...
    function loadGridView(data, empty) {
        ...
        $(xmlAssets).find("Asset").each(function (index, value) {
            $("td", row).eq(0).html("<img id='archive" + index + "' src='http://www.qmsrs.com/qmsrstools/Images/archive.jpg' class='imgButton' />");
