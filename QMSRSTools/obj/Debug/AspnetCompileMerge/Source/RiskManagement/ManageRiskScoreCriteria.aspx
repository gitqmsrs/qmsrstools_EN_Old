...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        <img id="new" src="http://www.qmsrs.com/qmsrstools/Images/new_file.png" class="imgButton" title="Create New Risk Score Criteria" alt=""/> 
    ...
    <div id="RiskTypeContainer" class="filter">
        <div id="RiskTypeFLabel" class="filterlabel">Risk Type:</div>
        <div id="RiskTypeFField" class="filterfield">
    ...
    <div id="RISKSCRwait" class="loader">
     ...
     <div id="ScoreScrollbar" class="gridscroll">
