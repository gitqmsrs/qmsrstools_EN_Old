...
<div id="wrapper" class="modulewrapper">
    ...
    <div id="RAGTooltip" class="tooltip" style="margin-top:10px;"> 
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="RED" src="http://www.qmsrs.com/qmsrstools/Images/Red.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Red: The management review is overdue.</p>
        </div>
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="GREEN" src="http://www.qmsrs.com/qmsrstools/Images/Green.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Green: The management review is on schedule.</p>
        </div>
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="AMBER" src="http://www.qmsrs.com/qmsrstools/Images/Amber.gif" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Amber: The management review has been delayed.</p>
        </div>
    </div>	
    ...
    <div id="ReviewOption" class="optionbox" style="top:110px; width:400px;">
        ...
        <div class="buttondiv">
            <img id='delete_review' src='http://www.qmsrs.com/qmsrstools/Images/deletenode.png' class='imgButton' alt="Remove Course" style='float:left;' title='Remove course' />
            <img id='edit_review' src='http://www.qmsrs.com/qmsrstools/Images/edit.png' class='imgButton' alt="Edit Course" style='float:left;' title='Edit course' />
        </div>
    </div>
    ...
    function filterByPlannedReviewDate(start, end) {
        ...
        function bindReviewData(data)
        {
            ...
            if (review != null)
            {
                ...
                $("#<%=REVDTTxt.ClientID%>").val(new Date(review.attr('PlannedReviewDate')).format("dd/MM/yyyy"));
                $("#<%=ACTREVDTTxt.ClientID%>").val(review.find("ActualReviewDate").text() == '' ? '' : new Date(review.find("ActualReviewDate").text()).format("dd/MM/yyyy"));
                $("#<%=ACTCLSDTTxt.ClientID%>").val(review.find("ActualCloseDate").text() == '' ? '' : new Date(review.find("ActualCloseDate").text()).format("dd/MM/yyyy"));
                ...
                if (review.attr('Objectives') != '' && review.attr('Objectives') != null)
                {
                    ...
                    $("#<%=OBJTxt.ClientID%>").html(review.attr('Objectives')).text();
                }
                else
                {
                ...
                if (review.attr('Summary') != '' && review.attr('Summary') != null) {
                    ...
                    $("#<%=SUMMTxt.ClientID%>").html(review.attr('Summary')).text();
                }
                else {
                ...
                if (review.attr('Notes') != '' && review.attr('Notes') != null)
                {
                    ...
                    $("#<%=NOTETxt.ClientID%>").html(review.attr('Notes')).text();
                }
                else
                {
