...
<script type="text/javascript" language="javascript">
    $(function ()
    {
        ...
        loadComboboxAjax2('loadDocumentFileTypes2', "#<%=RECFTYPCBox.ClientID%>", "#RECFTYP_LD");
        ...
        $("#save").bind('click', function () {
            ...
            if ($("#filename").val() != "" && (uploadedDoc != documentFileType)) {
                    ...
                    if (isAdditionalValid) {
                        ...
                        if (result == true) {
                            ...
                            var qualityrecord =
                            {
                                ...
                                RecordFileExtension: $("#<%=RECFTYPCBox.ClientID%>").val(),
