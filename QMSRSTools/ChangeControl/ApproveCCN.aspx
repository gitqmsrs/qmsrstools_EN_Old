...
<div id="wrapper" class="modulewrapper"> 
    ...
    <div style="float:left; width:100%; height:20px; margin-top:10px;">
        ...
        <div id="EmployeeField" class="fielddiv" style="width:170px">
            ...
            <input type="hidden"  id="hfEmployee"/>
        </div>
    </div>
...
<script type="text/javascript" language="javascript">
    $(function () {
        ...
        $("#hfEmployee").val($("#<%=EMPTxt.ClientID%>").val());
    ...
    function loadGridView(data, empty) {
        ...
        $(xmlCCN).find('CCN').each(function (index, ccn)
        {
            ...
            $("td", row).eq(1).html("<img id='icon_" + index + "' src='/Images/download.png' class='imgButton'/>");
            ...
            $("td", row).eq(6).html(originationdate.format("dd/MM/yyyy"));
    ...
    function hideAll() {
        ...
        reset();
        $("#<%=EMPTxt.ClientID%>").val($("#hfEmployee").val());
    }
