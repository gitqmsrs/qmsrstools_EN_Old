...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        <img id="newstatus" src="<%=GetSitePath() + "/Images/new_file.png" %>" class="imgButton" title="Create new asset maintenance status" alt=""/>  
        <img id="refreshstatus" src="<%=GetSitePath() + "/Images/refresh.png" %>" class="imgButton" title="Refresh Data" alt="" />
    </div>
