<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site2.Master" AutoEventWireup="true" Culture = "en-GB" CodeBehind="ElectricalTestStatusStatistics.aspx.cs" Inherits="QMSRSTools.AssetManagement.ElectricalTestStatusStatistics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="float:left; width:100%; height:500px; margin-top:15px;">
        ...
        <param name="movie" value="<%=GetSitePath() + "/Reports/Flash/fcp-pie-chart.swf" %>"/>
        <param name="bgcolor" value="#ffffff"/>
        <param name="quality" value="high"/>
        <param name="flashvars" value='xml_file=<%=Session["Guid"] %>'/>
        <embed bgcolor="#ffffff" flashvars='xml_file=<%=Session["Guid"] %>' height="500" name="flashchart" quality="high" src="<%=GetSitePath() + "/Reports/Flash/fcp-pie-chart.swf" %>" type="application/x-shockwave-flash" width="900"></embed>
