...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        <img id="newacquisition" src="<%=GetSitePath() + "/Images/new_file.png" %>" class="imgButton" title="Create new asset acquisition method" alt=""/>  
        <img id="refreshacquisition" src="<%=GetSitePath() + "/Images/refresh.png" %>" class="imgButton" title="Refresh Data" alt="" />
    </div>
