<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPage/Site2.Master"  CodeBehind="AssetListByCategory.aspx.cs" Inherits="QMSRSTools.AssetManagement.AssetListByCategory" %>
        ...
        <div id="Div1"  style=" float:left;width:200px; margin-left:10px; height:20px; margin-top:3px;">
                ...
                <div id="Div3" style="width:100px !important; left:0; float:left;" class="mid-width">
                                ...
                                <asp:ListBox ID="lstFields" runat="server" SelectionMode="Multiple" >
                                    ...
                                    <asp:ListItem Text="Price" Value="PurchasePrice" />
                                    <asp:ListItem Text="Currency" Value="CurrencyCode" />
