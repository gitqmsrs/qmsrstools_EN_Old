...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div id="AssetSupplierContainer" class="filter" style=" display:block;width:auto !important;">
        <div id="AssetSupplierLabel" class="filterlabel" style="width:auto !important;">Asset Supplier:</div>
        <div id="AssetSupplierField" class="filterfield" style="width:auto !important;">
            <asp:DropDownList ID="ASSTSUPPFCBox" AutoPostBack="true" runat="server" Width="140px" CssClass="comboboxfilter" OnSelectedIndexChanged="ASSTSUPPFCBox_SelectedIndexChanged">
            </asp:DropDownList>
