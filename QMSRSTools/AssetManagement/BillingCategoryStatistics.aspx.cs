...
{
    public partial class BillingCategoryStatistics : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                for (int i = 0; i < _context.BillingCategories.ToArray().Count(); i++)
                {
                    var billingcategory = _context.BillingCategories.ToArray()[i];
                    this.lstFields.Items.Insert(0, new ListItem(billingcategory.PaymentMethod, billingcategory.PaymentMethod));
                }
        ...
        protected void FillChart(List<string> _DisplayFields)
        {
            ...
            {
                var billingcategory = _context.BillingCategories.ToArray()[i];
                int assets = billingcategory.Assets.Count();
                ...
                oColumn.Name = billingcategory.PaymentMethod;
            ...
            oXml_Manager.CraeteXmlFile(Server.MapPath(""), "Average of Assets Per Billing Category", "", "", "");
