...
<div id="wrapper" class="modulewrapper">
    ...
    <div class="toolbox">
        ...
        <img id="new" src="<%=GetSitePath() + "/Images/new_file.png" %>" class="imgButton" title="Add New Calibration Record" alt=""/>
    </div>
    ...
    <div style="float:left; width:100%; height:20px; margin-top:15px;">
        ...
        <asp:RequiredFieldValidator ID="ASSTTAGTxtVal" runat="server" Display="None" ControlToValidate="ASSTTAGTxt" ErrorMessage="Enter the TAG of the asset" ValidationGroup="CalibrationGroup"></asp:RequiredFieldValidator>   
    </div>
    ...
    <div id="RAGTooltip" class="tooltip"  style="margin-top:20px; background-color:transparent;"> 
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="RED" src="<%=GetSitePath() + "/Images/Red.gif" %>" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Red: Asset is overdue for calibration.</p>
        </div>
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="GREEN" src="<%=GetSitePath() + "/Images/Green.gif" %>" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Green: Asset is not due for calibration.</p>
        </div>
        <div style="float:left;margin-top:2px; margin-left:2px; width:30%">
            <img id="AMBER" src="<%=GetSitePath() + "/Images/Amber.gif" %>" alt="" style="width:20px; float:left" /><p style="font-size:11px;">Amber: Asset will be due for calibration.</p>
        </div>
    </div>	
        ...
        function loadCalibrations(data)
        {
            ...
            $(xmlCalibrations).find('AssetExtensions').each(function (index, value) {
                ...
                $("#edit_" + index).bind('click', function ()
                {
                    ...
                    $("#<%=CALDTTxt.ClientID%>").val(extensiondate.format('dd/MM/yyyy'));

                    /* bind calibration due date*/
                    $("#<%=CALDUEDTTxt.ClientID%>").val($(value).find("ExtensionDueDate").text() == '' ? '' : extensionduedate.format("dd/MM/yyyy"));
